...
On the command line you configure that through `--cppcheck-build-dir=path`. Example:
    ...
    cppcheck --cppcheck-build-dir=b src # <- Faster! Results
    of unchanged files are reused
...
You can create a suppressions file for example as follows:
    ...
    // suppress memleak and exceptNew errors in the file
    src/file1.cpp
...
Suppressing multiple ids where macro is used:
    ...
    #define MACRO ...
    ...
    x = MACRO; // <- aaaa and bbbb warnings are suppressed
    here
