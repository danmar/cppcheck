...
void Check::reportError(const ErrorMessage& errmsg) { std::cout << errmsg.toXML() << std::endl; }
                        ...
                        Certainty::CertaintyLevel certainty)
{
    const ErrorMessage errmsg(callstack,
                              mTokenizer ? &mTokenizer->list : nullptr,
                              severity,
                              id,
                              msg,
                              cwe,
                              certainty,
                              mSettings ? mSettings->bugHunting : false);
    if (mErrorLogger)
...
void Check::reportError(const ErrorPath& errorPath,
                        ...
                        Certainty::CertaintyLevel certainty)
{
    const ErrorMessage errmsg(errorPath,
                              mTokenizer ? &mTokenizer->list : nullptr,
                              severity,
                              id,
                              msg,
