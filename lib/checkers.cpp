...
std::vector<checkers::IdMapping> checkers::idMappingMisraC{
    {"1.1", "syntaxError"},
    {"1.3", "error"},
    {"2.1", "alwaysFalse,duplicateBreak,unreachableCode"},
    ...
    {"9.1", "uninitvar"},
    {"12.3", "sizeofwithsilentarraypointer"},
    {"13.2", "unknownEvaluationOrder"},
    {"13.6", "sizeofCalculation"},
    {"14.3", "alwaysTrue,alwaysFalse,compareValueOutOfTypeRangeError,knownConditionTrueFalse"},
    {"17.4", "missingReturn"},
    {"17.5", "argumentSize"},
...
std::vector<checkers::Info> checkers::autosarInfo{
    {"m0-1-1", checkers::Req, "unreachableCode,duplicateBreak"},
    {"m0-1-2", checkers::Req, "unsignedLessThanZero"},
    {"m0-1-3", checkers::Req, "unusedVariable,unusedStructMember"},
    {"m0-1-4", checkers::Req, ""},
    {"a0-1-1", checkers::Req, "unreadVariable,unusedValue,redundantAssignment"},
    {"a0-1-2", checkers::Req, "misra-c2012-17.7"},
    {"m0-1-8", checkers::Req, ""},
    {"m0-1-9", checkers::Req, "redundantAssignment,redundantInitialization"},
    {"m0-1-10", checkers::Adv, "unusedFunction"},
    {"a0-1-3", checkers::Req, ""},
    {"a0-1-4", checkers::Req, ""},
    {"a0-1-5", checkers::Req, ""},
    {"a0-1-6", checkers::Adv, ""},
    {"m0-2-1", checkers::Req, "overlappingWriteUnion,overlappingWriteFunction"},
    {"a0-4-2", checkers::Req, ""},
    {"a0-4-3", checkers::Req, "?"},
    {"a0-4-4", checkers::Req, ""},
    {"a1-1-1", checkers::Req, "g++ .."},
    {"a1-4-3", checkers::Adv, "?"},
    {"a2-3-1", checkers::Req, "The code contains unhandled character(s) (character code=195). Neither unicode nor extended ascii is supported. [syntaxError]"},
    {"a2-5-1", checkers::Req, ""},
    {"a2-5-2", checkers::Req, ""},
    {"m2-7-1", checkers::Req, ""},
    {"a2-7-1", checkers::Req, ""},
    {"a2-7-3", checkers::Req, "doxygen,clang -Wdocumentation"},
    {"a2-8-2", checkers::Adv, ""},
    {"m2-10-1", checkers::Req, ""},
    {"a2-10-1", checkers::Req, "shadowVariable,shadowFunction,shadowArgument"},
    ...
    {"a2-13-2", checkers::Req, "compile error"},
    {"a2-13-3", checkers::Req, ""},
    {"a2-13-4", checkers::Req, "compiler error"},
    {"a3-1-1", checkers::Req, ""},
    {"a3-1-2", checkers::Req, ""},
    {"a3-1-3", checkers::Adv, ""},
    {"m3-1-2", checkers::Req, ""},
    ...
    {"a3-1-6", checkers::Adv, ""},
    {"m3-2-1", checkers::Req, ""},
    {"m3-2-2", checkers::Req, "ctuOneDefinitionRuleViolation"},
    {"m3-2-3", checkers::Req, ""},
    {"m3-2-4", checkers::Req, ""},
    {"a3-3-1", checkers::Req, ""},
    {"a3-3-2", checkers::Req, ""},
    {"m3-3-2", checkers::Req, ""},
    {"m3-4-1", checkers::Req, "variableScope"},
    {"m3-9-1", checkers::Req, ""},
    {"a3-9-1", checkers::Req, ""},
    {"m3-9-3", checkers::Req, ""},
    {"m4-5-1", checkers::Req, ""},
    ...
    {"a5-0-1", checkers::Req, "-Wsequence-point"},
    {"m5-0-2", checkers::Adv, ""},
    {"m5-0-3", checkers::Req, ""},
    {"m5-0-4", checkers::Req, ""},
    {"m5-0-5", checkers::Req, ""},
    ...
    {"m5-0-16", checkers::Req, "pointerOutOfBounds"},
    {"m5-0-17", checkers::Req, "comparePointers"},
    {"a5-0-4", checkers::Req, ""},
    {"m5-0-18", checkers::Req, "comparePointers"},
    {"a5-0-3", checkers::Req, ""},
    ...
    {"a5-1-2", checkers::Req, ""},
    {"a5-1-3", checkers::Req, ""},
    {"a5-1-4", checkers::Req, "returnDanglingLifetime"},
    {"a5-1-6", checkers::Adv, ""},
    {"a5-1-7", checkers::Req, ""},
    {"a5-1-8", checkers::Adv, ""},
    {"a5-1-9", checkers::Adv, ""},
    ...
    {"m5-2-3", checkers::Adv, ""},
    {"a5-2-1", checkers::Adv, ""},
    {"a5-2-2", checkers::Req, "cstyleCast"},
    {"a5-2-3", checkers::Req, ""},
    {"m5-2-6", checkers::Req, ""},
    {"a5-2-4", checkers::Req, ""},
    {"a5-2-6", checkers::Req, ""},
    ...
    {"a5-2-5", checkers::Req, "arrayIndexOutOfBounds,arrayIndexOutOfBoundsCond,pointerOutOfBounds,pointerOutOfBoundsCond,negativeIndex,arrayIndexThenCheck,bufferAccessOutOfBounds,objectIndex,argumentSize"},
    {"m5-2-12", checkers::Req, ""},
    {"m5-3-1", checkers::Req, ""},
    {"m5-3-2", checkers::Req, ""},
    {"m5-3-3", checkers::Req, ""},
    {"m5-3-4", checkers::Req, "sizeofFunctionCall"},
    {"a5-3-1", checkers::Req, ""},
    {"a5-3-2", checkers::Req, "nullPointer,nullPointerRedundantCheck,nullPointerArithmetic,nullPointerArithmeticRedundantCheck,nullPointerDefaultArg"},
    {"a5-3-3", checkers::Req, ""},
    {"a5-5-1", checkers::Req, ""},
    {"a5-6-1", checkers::Req, "zerodiv,zerodivcond"},
    {"m5-8-1", checkers::Req, "shiftTooManyBits"},
    ...
    {"a6-5-3", checkers::Adv, ""},
    {"a6-5-4", checkers::Adv, ""},
    {"a6-6-1", checkers::Req, "misra-c2012-15.1"},
    {"m6-6-1", checkers::Req, ""},
    {"m6-6-2", checkers::Req, ""},
    {"m6-6-3", checkers::Req, ""},
    {"a7-1-1", checkers::Req, ""},
    {"a7-1-2", checkers::Req, ""},
    {"m7-1-2", checkers::Req, "constParameter"},
    {"a7-1-3", checkers::Req, ""},
    {"a7-1-4", checkers::Req, ""},
    {"a7-1-5", checkers::Req, ""},
    {"a7-1-6", checkers::Req, ""},
    ...
    {"m7-4-2", checkers::Req, ""},
    {"m7-4-3", checkers::Req, ""},
    {"a7-5-1", checkers::Req, "returnDanglingLifetime"},
    {"a7-5-2", checkers::Req, "premium-misra-c2012-17.2"},
    {"a7-6-1", checkers::Req, ""},
    {"m8-0-1", checkers::Req, ""},
    {"a8-2-1", checkers::Req, ""},
    {"m8-3-1", checkers::Req, ""},
    {"a8-4-1", checkers::Req, ""},
    {"m8-4-2", checkers::Req, "funcArgNamesDifferent"},
    {"a8-4-2", checkers::Req, "missingReturn"},
    {"m8-4-4", checkers::Req, ""},
    {"a8-4-4", checkers::Adv, ""},
    {"a8-4-5", checkers::Req, ""},
    {"a8-4-6", checkers::Req, ""},
    ...
    {"a8-5-0", checkers::Req, "uninitData"},
    {"a8-5-1", checkers::Req, ""},
    {"m8-5-2", checkers::Req, ""},
    {"a8-5-2", checkers::Req, ""},
    {"a8-5-3", checkers::Req, ""},
    ...
    {"m9-3-1", checkers::Req, ""},
    {"a9-3-1", checkers::Req, ""},
    {"m9-3-3", checkers::Req, "functionConst,functionStatic"},
    {"a9-5-1", checkers::Req, "misra-c2012-19.2"},
    {"a9-6-1", checkers::Req, ""},
    {"m9-6-4", checkers::Req, ""},
    ...
    {"m10-2-1", checkers::Adv, "duplInheritedMember,"},
    ...
    {"a12-1-1", checkers::Req, "uninitMember"},
    {"m12-1-1", checkers::Req, "virtualCallInConstructor"},
    {"a12-1-2", checkers::Req, ""},
    {"a12-1-3", checkers::Req, ""},
    {"a12-1-4", checkers::Req, "noExplicitConstructor"},
    {"a12-1-5", checkers::Req, ""},
    {"a12-1-6", checkers::Req, ""},
    {"a12-4-1", checkers::Req, ""},
    {"a12-4-2", checkers::Adv, ""},
    {"a12-6-1", checkers::Req, "useInitializationList"},
    {"a12-7-1", checkers::Req, ""},
    {"a12-8-1", checkers::Req, ""},
    {"a12-8-2", checkers::Adv, ""},
    {"a12-8-3", checkers::Req, "accessMoved"},
    ...
    {"a15-1-4", checkers::Req, "memleak"},
    {"a15-2-1", checkers::Req, ""},
    {"a15-2-2", checkers::Req, ""},
    {"m15-3-1", checkers::Req, "exceptThrowInDestructor"},
    ...
    {"a15-4-2", checkers::Req, "throwInNoexceptFunction"},
    ...
    {"m16-0-5", checkers::Req, "preprocessorErrorDirective"},
    ...
    {"a16-2-1", checkers::Req, "misra-c2012-20.2"},
    {"a16-2-2", checkers::Req, "iwyu,check headers"},
    ...
    {"a18-5-3", checkers::Req, "mismatchAllocDealloc"},
    ...
    {"a20-8-1", checkers::Req, "doubleFree"},
    ...
    {"a23-0-2", checkers::Req, "invalidContainer"},
...
std::vector<checkers::Info> checkers::certCInfo{
    {"PRE30-C", "L3", "preprocessorErrorDirective"},
    {"PRE31-C", "L3", ""},
    {"PRE32-C", "L3", "preprocessorErrorDirective"},
    {"DCL30-C", "L2", "danglingLifetime,autoVariables,invalidLifetime"},
    {"DCL31-C", "L3", ""},
    {"DCL36-C", "L2", ""},
    {"DCL37-C", "L3", ""},
    {"DCL38-C", "L3", ""},
    ...
    {"DCL40-C", "L3", ""},
    {"DCL41-C", "L3", ""},
    {"EXP30-C", "L2", "unknownEvaluationOrder"},
    {"EXP32-C", "L2", ""},
    {"EXP33-C", "L1", "uninitvar,uninitdata,uninitStructMember"},
    {"EXP34-C", "L1", "nullPointer,nullPointerDefaultArg,nullPointerRedundantCheck,nullPointerArithmetic,nullPointerArithmeticRedundantCheck"},
    {"EXP35-C", "L3", ""},
    {"EXP36-C", "L3", ""},
    {"EXP37-C", "L3", ""},
    {"EXP39-C", "L3", ""},
    ...
    {"EXP42-C", "L2", ""},
    {"EXP43-C", "L3", ""},
    {"EXP44-C", "L3", "sizeofCalculation"},
    {"EXP45-C", "L2", ""},
    {"EXP46-C", "L2", "bitwiseOnBoolean"},
    {"INT30-C", "L2", ""},
    {"INT31-C", "L2", ""},
    {"INT32-C", "L2", ""},
    {"INT33-C", "L2", ""},
    ...
    {"INT36-C", "L3", ""},
    {"FLP30-C", "L2", ""},
    {"FLP32-C", "L2", "invalidFunctionArg"},
    {"FLP34-C", "L3", "floatConversionOverflow"},
    {"FLP36-C", "L3", ""},
    {"FLP37-C", "L3", ""},
    {"ARR30-C", "L2", ""},
    {"ARR32-C", "L2", ""},
    {"ARR36-C", "L2", "comparePointers"},
    {"ARR37-C", "L2", ""},
    {"ARR38-C", "L1", ""},
    {"ARR39-C", "L2", ""},
    {"STR30-C", "L2", "stringLiteralWrite"},
    {"STR31-C", "L1", ""},
    {"STR32-C", "L1", ""},
    {"STR34-C", "L2", ""},
    {"STR37-C", "L3", "invalidFunctionArg"},
    {"STR38-C", "L1", ""},
    {"MEM30-C", "L1", "doubleFree,deallocret,deallocuse"},
    {"MEM31-C", "L2", "memleak,leakReturnValNotUsed,leakUnsafeArgAlloc,memleakOnRealloc"},
    {"MEM33-C", "L3", ""},
    {"MEM34-C", "L1", "autovarInvalidDeallocation,mismatchAllocDealloc"},
    {"MEM35-C", "L2", ""},
    {"MEM36-C", "L3", ""},
    {"FIO30-C", "L1", ""},
    {"FIO32-C", "L3", ""},
    ...
    {"FIO37-C", "L1", ""},
    {"FIO38-C", "L3", ""},
    {"FIO39-C", "L2", "IOWithoutPositioning"},
    {"FIO40-C", "L3", ""},
    {"FIO41-C", "L3", ""},
    {"FIO42-C", "L3", "resourceLeak"},
    {"FIO44-C", "L3", ""},
    {"FIO45-C", "L2", ""},
    {"FIO46-C", "L3", "useClosedFile"},
    {"FIO47-C", "L2", "invalidscanf,wrongPrintfScanfArgNum,invalidLengthModifierError,invalidScanfFormatWidth,wrongPrintfScanfParameterPositionError"},
    {"ENV30-C", "L3", ""},
    {"ENV31-C", "L3", ""},
    {"ENV32-C", "L1", ""},
    {"ENV33-C", "L1", ""},
...
std::vector<checkers::Info> checkers::certCppInfo{
    ...
    {"DCL53-CPP", "L3", ""},
    {"DCL54-CPP", "L2", ""},
    {"DCL55-CPP", "L3", "premium-cert-dcl39-c"},
    {"DCL56-CPP", "L3", ""},
    {"DCL57-CPP", "L3", "deallocThrow,exceptThrowInDestructor"},
    {"DCL58-CPP", "L3", ""},
    {"DCL59-CPP", "L3", ""},
    {"DCL60-CPP", "L3", "ctuOneDefinitionRuleViolation"},
    {"EXP50-CPP", "L2", ""},
    {"EXP51-CPP", "L3", ""},
    {"EXP52-CPP", "L3", "sizeofCalculation"},
    {"EXP53-CPP", "L1", "uninitvar"},
    {"EXP54-CPP", "L2", "uninitvar,danglingLifetime,danglingReference,danglingTemporaryLifetime,danglingTempReference,returnDanglingLifetime"},
    {"EXP55-CPP", "L2", ""},
    {"EXP56-CPP", "L3", ""},
    {"EXP57-CPP", "L3", ""},
    {"EXP58-CPP", "L3", ""},
    {"EXP59-CPP", "L3", ""},
    {"EXP60-CPP", "L1", ""},
    {"EXP61-CPP", "L2", "danglingLifetime,danglingReference,danglingTemporaryLifetime,danglingTempReference,returnDanglingLifetime"},
    {"EXP62-CPP", "L2", "premium-cert-exp42-c"},
    {"EXP63-CPP", "L2", "accessMoved"},
    {"INT50-CPP", "L3", ""},
    {"CTR50-CPP", "L2", ""},
    {"CTR51-CPP", "L2", "eraseDereference"},
    {"CTR52-CPP", "L1", ""},
    {"CTR53-CPP", "L2", ""},
    {"CTR54-CPP", "L2", "comparePointers"},
    {"CTR55-CPP", "L1", "containerOutOfBounds"},
    {"CTR56-CPP", "L2", ""},
    {"CTR57-CPP", "L3", ""},
    {"CTR58-CPP", "L3", ""},
    {"STR50-CPP", "L1", ""},
    {"STR51-CPP", "L1", "nullPointer"},
    {"STR52-CPP", "L2", "invalidContainer"},
    {"STR53-CPP", "L2", ""},
    {"MEM50-CPP", "L1", "deallocuse"},
    {"MEM51-CPP", "L1", "mismatchAllocDealloc"},
    {"MEM52-CPP", "L1", ""},
    {"MEM53-CPP", "L1", ""},
    {"MEM54-CPP", "L1", ""},
    {"MEM55-CPP", "L1", ""},
    {"MEM56-CPP", "L1", "doubleFree"},
    {"MEM57-CPP", "L2", ""},
    {"FIO50-CPP", "L2", "IOWithoutPositioning"},
    {"FIO51-CPP", "L3", ""},
    {"ERR50-CPP", "L3", ""},
    {"ERR51-CPP", "L3", ""},
    {"ERR52-CPP", "L3", ""},
    ...
    {"ERR55-CPP", "L2", ""},
    {"ERR56-CPP", "L2", ""},
    {"ERR57-CPP", "L3", "memleak"},
    {"ERR58-CPP", "L2", ""},
    {"ERR59-CPP", "L1", ""},
    {"ERR60-CPP", "L3", ""},
    {"ERR61-CPP", "L3", ""},
    {"ERR62-CPP", "L3", ""},
    {"OOP50-CPP", "L3", "virtualCallInConstructor"},
    {"OOP51-CPP", "L3", ""},
    {"OOP52-CPP", "L2", "virtualDestructor"},
    {"OOP53-CPP", "L3", "initializerList"},
    {"OOP54-CPP", "L3", "operatorEqToSelf"},
    {"OOP55-CPP", "L2", ""},
    {"OOP56-CPP", "L3", ""},
    {"OOP57-CPP", "L2", ""},
    {"OOP58-CPP", "L2", ""},
