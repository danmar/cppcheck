...
const ValueFlow::Value* ProgramMemory::getValue(MathLib::bigint exprid, bool impossible) const
{
...
bool ProgramMemory::getContainerEmptyValue(MathLib::bigint exprid, MathLib::bigint* result) const
{
