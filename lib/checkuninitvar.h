...
public:
    ...
    const Token* checkExpr(const Token* tok,
                           const Variable& var,
                           const Alloc alloc,
                           bool known,
    ...
    static int isFunctionParUsage(const Token* vartok,
                                  const Library& library,
                                  bool pointer,
                                  Alloc alloc,
                                  int indirect = 0);
...
private:
    ...
    static std::string myName() { return "Uninitialized variables"; }
