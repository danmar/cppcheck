...
public:
    ...
    static bool comparisonNonZeroExpressionLessThanZero(const Token* tok,
    ...
    static bool testIfNonZeroExpressionIsPositive(const Token* tok,
                                                  const ValueFlow::Value** zeroValue,
                                                  const Token** nonZeroExpr);
    ...
    /** @brief %Check that variadic function calls don't use NULL. If NULL is \#defined as 0 and the function expects a
...
private:
    // Error messages..
    void checkComparisonFunctionIsAlwaysTrueOrFalseError(const Token* tok,
    ...
    void invalidPointerCastError(const Token* tok,
    ...
    void incompleteArrayFillError(const Token* tok,
    ...
    void accessMovedError(const Token* tok,
                          const std::string& varname,
                          const ValueFlow::Value* value,
                          bool inconclusive);
    void funcArgNamesDifferent(const std::string& functionName,
                               nonneg int index,
                               const Token* declaration,
                               const Token* definition);
    void funcArgOrderDifferent(const std::string& functionName,
                               const Token* declaration,
                               const Token* definition,
    ...
    void knownArgumentError(const Token* tok,
                            const Token* ftok,
                            const ValueFlow::Value* value,
