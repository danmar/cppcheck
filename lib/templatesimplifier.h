...
public:
    ...
    class TokenAndName {
        ...
        void isClass(bool state) { setFlag(fIsClass, state); }
        void isFunction(bool state) { setFlag(fIsFunction, state); }
        void isVariable(bool state) { setFlag(fIsVariable, state); }
        void isAlias(bool state) { setFlag(fIsAlias, state); }
        void isSpecialization(bool state) { setFlag(fIsSpecialization, state); }
        void isPartialSpecialization(bool state) { setFlag(fIsPartialSpecialization, state); }
        void isForwardDeclaration(bool state) { setFlag(fIsForwardDeclaration, state); }
    ...
    public:
        ...
        void token(Token* token) { mToken = token; }
        ...
        void paramEnd(const Token* end) { mParamEnd = end; }

        bool isClass() const { return getFlag(fIsClass); }
        bool isFunction() const { return getFlag(fIsFunction); }
        bool isVariable() const { return getFlag(fIsVariable); }
        bool isAlias() const { return getFlag(fIsAlias); }
        bool isSpecialization() const { return getFlag(fIsSpecialization); }
        bool isPartialSpecialization() const { return getFlag(fIsPartialSpecialization); }
        bool isForwardDeclaration() const { return getFlag(fIsForwardDeclaration); }
     ...
     * @return match => true
     */
    static bool instantiateMatch(const Token* instance,
     ...
     */
    void simplifyTemplates(const std::time_t maxtime, bool& codeWithTemplates);
