...
void Tokenizer::reportError(std::list<const Token*> callstack, Severity::SeverityType severity, const std::string& id, const std::string& msg, bool inconclusive) const
{
