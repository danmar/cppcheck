...
static void fillProgramMemoryFromAssignments(ProgramMemoryFast& pm, const Token* tok, const ProgramMemoryFast& state, std::unordered_map<nonneg int, ValueFlow::Value> vars)
{
    int indentlevel = 0;
