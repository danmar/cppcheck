...
# Build system integration removed - now using cppcheck's built-in project parsing
...
re_define_file_offset_bits_64 = re.compile(r'^\s*#\s*define\s+_FILE_OFFSET_BITS\s+64\s*$')
        ...
        for directive in cfg.directives:
            ...
            if re_define_time_bits_64.match(directive.str):
                ...
                if not effective_flags['time_bits_defined']:
                    ...
                    effective_flags['time_bits_value'] = 64
                    time_bits_defined = True
            ...
            if re_define_file_offset_bits_64.match(directive.str):
                ...
                source_file_offset_bits_value = 64
