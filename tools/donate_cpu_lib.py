...
def scan_package(cppcheck_path, source_path, libraries, capture_callstack=True):
    ...
    options = libs + ' --showtime=top5 --check-library --inconclusive --enable=style,performance,portability,warning,information --inline-suppr --disable=missingInclude --suppress=unmatchedSuppression --template=daca2'
