...
// egrep '[^"]"},$' misrac2012.h | egrep -v 'misra-c2012' | sed 's|", ".*", "|", "|'
...
// egrep '[^"]"},$' misracpp2008.h | egrep -v 'misra' | sed 's|", ".*", "|", "|'
...
// egrep '[^"]"},$' misracpp2023.h | egrep -v 'misra' | sed 's|", ".*", "|", "|'
...
// egrep '[^"]"},$' autosar.h | egrep -v 'autosar|misra' | sed 's|", ".*", "|", "|'
...
// egrep '[^"]"},$' cert_c.h | egrep -v 'cert' | sed 's|", ".*", "|", "|'
...
// egrep '[^"]"},$' cert_cpp.h | egrep -v 'cert' | sed 's|", ".*", "|", "|'
