...
private:
    ...
    void ErrorMessageConstruct() const {
        ...
        ErrorMessage msg(std::move(locs), "", Severity::error, "errorId", "Programming error.", Certainty::normal);
    ...
    void ErrorMessageVerbose() const {
        std::list<ErrorMessage::FileLocation> locs(1, fooCpp5);
        ErrorMessage msg(std::move(locs), "", Severity::error, "errorId", "Programming error.\nVerbose error", Certainty::normal);
        ASSERT_EQUALS(1, msg.callStack.size());
        ASSERT_EQUALS("Programming error.", msg.shortMessage());
    ...
    void ToXmlV2Encoding() const {
        {
            ErrorMessage msg({}, "", Severity::error, "errorId", "Programming error.\nComparing \"\203\" with \"\003\"", Certainty::normal);
        ...
        }
        {
            ...
            ErrorMessage msg1({}, "", Severity::error, "errorId", std::string("Programming error.\nReading \"")+code1+"\"", Certainty::normal);
            ASSERT_EQUALS("        <error id=\"errorId\" severity=\"error\" msg=\"Programming error.\" verbose=\"Reading &quot;\\303\\244\\303\\266\\303\\274&quot;\"/>", msg1.toXML());
            ErrorMessage msg2({}, "", Severity::error, "errorId", std::string("Programming error.\nReading \"")+code2+"\"", Certainty::normal);
    ...
    void InconclusiveXml() const {
        ...
        ErrorMessage msg(std::move(locs), "", Severity::error, "errorId", "Programming error", Certainty::inconclusive);
    ...
    void SerializeInconclusiveMessage() const {
        // Inconclusive error message
        ErrorMessage msg({}, "", Severity::error, "errorId", "Programming error", Certainty::inconclusive);
        msg.file0 = "test.cpp";
    ...
    void SerializeSanitize() const {
        ErrorMessage msg({}, "", Severity::error, "errorId", std::string("Illegal character in \"foo\001bar\""), Certainty::normal);
        msg.file0 = "1.c";
    ...
    void SerializeFileLocation() const {
        ...
        ErrorMessage msg({std::move(loc1)}, "", Severity::error, "errorId", "Programming error", Certainty::inconclusive);
    ...
    void SerializeAndDeserialize() const {
        ErrorMessage msg({}, "", Severity::warning, "id", "$symbol:var\nmessage $symbol", Certainty::normal);
