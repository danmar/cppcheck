...
protected:
    ...
    void todoAssertEquals(const char* const filename,
                          const unsigned int linenr,
...
#define ASSERT(CONDITION)                                                                                              \
    if (!assert_(__FILE__, __LINE__, (CONDITION)))                                                                     \
    return
...
#define ASSERT_EQUALS(EXPECTED, ACTUAL)                                                                                \
    ...
    return
#define ASSERT_EQUALS_WITHOUT_LINENUMBERS(EXPECTED, ACTUAL)                                                            \
    assertEqualsWithoutLineNumbers(__FILE__, __LINE__, EXPECTED, ACTUAL)
#define ASSERT_EQUALS_DOUBLE(EXPECTED, ACTUAL, TOLERANCE)                                                              \
    assertEqualsDouble(__FILE__, __LINE__, EXPECTED, ACTUAL, TOLERANCE)
#define ASSERT_EQUALS_MSG(EXPECTED, ACTUAL, MSG) assertEquals(__FILE__, __LINE__, EXPECTED, ACTUAL, MSG)
#define ASSERT_THROW(CMD, EXCEPTION)                                                                                   \
    do {                                                                                                               \
        try {                                                                                                          \
            CMD;                                                                                                       \
...
#define ASSERT_THROW_EQUALS(CMD, EXCEPTION, EXPECTED)                                                                  \
    do {                                                                                                               \
        try {                                                                                                          \
            CMD;                                                                                                       \
            assertThrowFail(__FILE__, __LINE__);                                                                       \
        } catch (const EXCEPTION& e) {                                                                                 \
            assertEquals(__FILE__, __LINE__, EXPECTED, e.errorMessage);                                                \
        } catch (...) {                                                                                                \
            assertThrowFail(__FILE__, __LINE__);                                                                       \
        }                                                                                                              \
    } while (false)
#define ASSERT_NO_THROW(CMD)                                                                                           \
    do {                                                                                                               \
        try {                                                                                                          \
            ...
            assertNoThrowFail(__FILE__, __LINE__);                                                                     \
        }                                                                                                              \
    } while (false)
#define TODO_ASSERT_THROW(CMD, EXCEPTION)                                                                              \
    do {                                                                                                               \
        try {                                                                                                          \
            CMD;                                                                                                       \
        } catch (const EXCEPTION&) {                                                                                   \
        } catch (...) {                                                                                                \
            assertThrow(__FILE__, __LINE__);                                                                           \
        }                                                                                                              \
    } while (false)
#define TODO_ASSERT(CONDITION)                                                                                         \
    do {                                                                                                               \
        const bool condition = (CONDITION);                                                                            \
        todoAssertEquals(__FILE__, __LINE__, true, false, condition);                                                  \
    } while (false)
