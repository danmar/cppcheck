...
#define checkHdrs(...) checkHdrs_(__FILE__, __LINE__, __VA_ARGS__)
    ...
    void testDirectiveIncludeTypes() {
        ...
        const char dumpdata[] = "  <directivelist>\n"
                                ...
                                "      <token line=\"1\" column=\"1\" str=\"#\"/>\n"
                                "      <token line=\"1\" column=\"2\" str=\"define\"/>\n"
                                "      <token line=\"1\" column=\"9\" str=\"macro\"/>\n"
                                "      <token line=\"1\" column=\"15\" str=\"some\"/>\n"
                                "      <token line=\"1\" column=\"20\" str=\"definition\"/>\n"
                                "    </directive>\n"
                                "    <directive file=\"test.c\" linenr=\"2\" str=\"#undef macro\">\n"
                                "      <token line=\"2\" column=\"1\" str=\"#\"/>\n"
                                "      <token line=\"2\" column=\"2\" str=\"undef\"/>\n"
                                "      <token line=\"2\" column=\"8\" str=\"macro\"/>\n"
                                "    </directive>\n"
                                "    <directive file=\"test.c\" linenr=\"3\" str=\"#ifdef macro\">\n"
                                "      <token line=\"3\" column=\"1\" str=\"#\"/>\n"
                                "      <token line=\"3\" column=\"2\" str=\"ifdef\"/>\n"
                                "      <token line=\"3\" column=\"8\" str=\"macro\"/>\n"
                                "    </directive>\n"
                                "    <directive file=\"test.c\" linenr=\"4\" str=\"#elif some (complex) condition\">\n"
                                "      <token line=\"4\" column=\"1\" str=\"#\"/>\n"
                                "      <token line=\"4\" column=\"2\" str=\"elif\"/>\n"
                                "      <token line=\"4\" column=\"7\" str=\"some\"/>\n"
                                "      <token line=\"4\" column=\"12\" str=\"(\"/>\n"
                                "      <token line=\"4\" column=\"13\" str=\"complex\"/>\n"
                                "      <token line=\"4\" column=\"20\" str=\")\"/>\n"
                                "      <token line=\"4\" column=\"22\" str=\"condition\"/>\n"
                                "    </directive>\n"
                                "    <directive file=\"test.c\" linenr=\"5\" str=\"#else\">\n"
                                "      <token line=\"5\" column=\"1\" str=\"#\"/>\n"
                                "      <token line=\"5\" column=\"2\" str=\"else\"/>\n"
                                "    </directive>\n"
                                "    <directive file=\"test.c\" linenr=\"6\" str=\"#endif\">\n"
                                "      <token line=\"6\" column=\"1\" str=\"#\"/>\n"
                                "      <token line=\"6\" column=\"2\" str=\"endif\"/>\n"
                                "    </directive>\n"
                                "    <directive file=\"test.c\" linenr=\"7\" str=\"#if some other condition\">\n"
                                "      <token line=\"7\" column=\"1\" str=\"#\"/>\n"
                                "      <token line=\"7\" column=\"2\" str=\"if\"/>\n"
                                "      <token line=\"7\" column=\"5\" str=\"some\"/>\n"
                                "      <token line=\"7\" column=\"10\" str=\"other\"/>\n"
                                "      <token line=\"7\" column=\"16\" str=\"condition\"/>\n"
                                "    </directive>\n"
                                "    <directive file=\"test.c\" linenr=\"8\" str=\"#pragma some proprietary content\">\n"
                                "      <token line=\"8\" column=\"1\" str=\"#\"/>\n"
                                "      <token line=\"8\" column=\"2\" str=\"pragma\"/>\n"
                                "      <token line=\"8\" column=\"9\" str=\"some\"/>\n"
                                "      <token line=\"8\" column=\"14\" str=\"proprietary\"/>\n"
                                "      <token line=\"8\" column=\"26\" str=\"content\"/>\n"
                                "    </directive>\n"
                                "    <directive file=\"test.c\" linenr=\"9\" str=\"#\">\n"
                                "      <token line=\"9\" column=\"1\" str=\"#\"/>\n"
                                "    </directive>\n"
                                "    <directive file=\"test.c\" linenr=\"10\" str=\"#ident some text\">\n"
                                "      <token line=\"10\" column=\"1\" str=\"#\"/>\n"
                                "      <token line=\"10\" column=\"2\" str=\"ident\"/>\n"
                                "      <token line=\"10\" column=\"8\" str=\"some\"/>\n"
                                "      <token line=\"10\" column=\"13\" str=\"text\"/>\n"
                                "    </directive>\n"
                                "    <directive file=\"test.c\" linenr=\"11\" str=\"#unknownmacro some unpredictable text\">\n"
                                "      <token line=\"11\" column=\"1\" str=\"#\"/>\n"
                                "      <token line=\"11\" column=\"2\" str=\"unknownmacro\"/>\n"
                                "      <token line=\"11\" column=\"15\" str=\"some\"/>\n"
                                "      <token line=\"11\" column=\"20\" str=\"unpredictable\"/>\n"
                                "      <token line=\"11\" column=\"34\" str=\"text\"/>\n"
                                "    </directive>\n"
                                "    <directive file=\"test.c\" linenr=\"12\" str=\"#warning some warning message\">\n"
                                "      <token line=\"12\" column=\"1\" str=\"#\"/>\n"
                                "      <token line=\"12\" column=\"2\" str=\"warning\"/>\n"
                                "      <token line=\"12\" column=\"10\" str=\"some warning message\"/>\n"
                                "    </directive>\n"
                                "    <directive file=\"test.c\" linenr=\"13\" str=\"#error some error message\">\n"
                                "      <token line=\"13\" column=\"1\" str=\"#\"/>\n"
                                "      <token line=\"13\" column=\"2\" str=\"error\"/>\n"
                                "      <token line=\"13\" column=\"8\" str=\"some error message\"/>\n"
                                "    </directive>\n"
                                "  </directivelist>\n"
                                "  <tokenlist>\n"
                                "  </tokenlist>\n";
    ...
    void testDirectiveIncludeLocations() {
        ...
        const char dumpdata[] = "  <directivelist>\n"
                                ...
                                "      <token line=\"1\" column=\"1\" str=\"#\"/>\n"
                                "      <token line=\"1\" column=\"2\" str=\"define\"/>\n"
                                "      <token line=\"1\" column=\"9\" str=\"macro1\"/>\n"
                                "      <token line=\"1\" column=\"16\" str=\"val\"/>\n"
                                "    </directive>\n"
                                "    <directive file=\"test.c\" linenr=\"2\" str=\"#include &quot;inc1.h&quot;\">\n"
                                "      <token line=\"2\" column=\"1\" str=\"#\"/>\n"
                                "      <token line=\"2\" column=\"2\" str=\"file\"/>\n"
                                "      <token line=\"2\" column=\"7\" str=\"&quot;inc1.h&quot;\"/>\n"
                                "    </directive>\n"
                                "    <directive file=\"inc1.h\" linenr=\"1\" str=\"#define macro2 val\">\n"
                                "      <token line=\"1\" column=\"1\" str=\"#\"/>\n"
                                "      <token line=\"1\" column=\"2\" str=\"define\"/>\n"
                                "      <token line=\"1\" column=\"9\" str=\"macro2\"/>\n"
                                "      <token line=\"1\" column=\"16\" str=\"val\"/>\n"
                                "    </directive>\n"
                                "    <directive file=\"inc1.h\" linenr=\"2\" str=\"#include &quot;inc2.h&quot;\">\n"
                                "      <token line=\"2\" column=\"1\" str=\"#\"/>\n"
                                "      <token line=\"2\" column=\"2\" str=\"file\"/>\n"
                                "      <token line=\"2\" column=\"7\" str=\"&quot;inc2.h&quot;\"/>\n"
                                "    </directive>\n"
                                "    <directive file=\"inc2.h\" linenr=\"1\" str=\"#define macro3 val\">\n"
                                "      <token line=\"1\" column=\"1\" str=\"#\"/>\n"
                                "      <token line=\"1\" column=\"2\" str=\"define\"/>\n"
                                "      <token line=\"1\" column=\"9\" str=\"macro3\"/>\n"
                                "      <token line=\"1\" column=\"16\" str=\"val\"/>\n"
                                "    </directive>\n"
                                "    <directive file=\"inc1.h\" linenr=\"3\" str=\"#define macro4 val\">\n"
                                "      <token line=\"3\" column=\"1\" str=\"#\"/>\n"
                                "      <token line=\"3\" column=\"2\" str=\"define\"/>\n"
                                "      <token line=\"3\" column=\"9\" str=\"macro4\"/>\n"
                                "      <token line=\"3\" column=\"16\" str=\"val\"/>\n"
                                "    </directive>\n"
                                "    <directive file=\"test.c\" linenr=\"3\" str=\"#define macro5 val\">\n"
                                "      <token line=\"3\" column=\"1\" str=\"#\"/>\n"
                                "      <token line=\"3\" column=\"2\" str=\"define\"/>\n"
                                "      <token line=\"3\" column=\"9\" str=\"macro5\"/>\n"
                                "      <token line=\"3\" column=\"16\" str=\"val\"/>\n"
                                "    </directive>\n"
                                "  </directivelist>\n"
                                "  <tokenlist>\n"
    ...
    void testDirectiveIncludeComments() {
        ...
        const char dumpdata[] = "  <directivelist>\n"
                                ...
                                "      <token line=\"1\" column=\"1\" str=\"#\"/>\n"
                                "      <token line=\"1\" column=\"2\" str=\"ifdef\"/>\n"
                                "      <token line=\"1\" column=\"8\" str=\"macro2\"/>\n"
                                "    </directive>\n"
                                "    <directive file=\"test.c\" linenr=\"2\" str=\"#else\">\n"
                                "      <token line=\"2\" column=\"1\" str=\"#\"/>\n"
                                "      <token line=\"2\" column=\"2\" str=\"else\"/>\n"
                                "    </directive>\n"
                                "    <directive file=\"test.c\" linenr=\"3\" str=\"#endif\">\n"
                                "      <token line=\"3\" column=\"1\" str=\"#\"/>\n"
                                "      <token line=\"3\" column=\"2\" str=\"endif\"/>\n"
                                "    </directive>\n"
                                "  </directivelist>\n"
                                "  <tokenlist>\n"
                                "  </tokenlist>\n";
