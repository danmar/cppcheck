...
#define checkNormal(code) checkNormal_(code, __FILE__, __LINE__)
    ...
    void invalidContainer() {
        ...
        check("void f(std::vector<int> v) {\n"
                ...
                "}\n",
              true);
        ASSERT_EQUALS("[test.cpp:2] -> [test.cpp:3] -> [test.cpp:4] -> [test.cpp:1] -> [test.cpp:5]: (error) Using iterator to local container 'v' that may be invalid.\n", errout.str());
        ...
        check("void f(std::vector<int> v) {\n"
                ...
                "}\n",
              true);
        ASSERT_EQUALS("[test.cpp:2] -> [test.cpp:4] -> [test.cpp:1] -> [test.cpp:5]: (error) Using iterator to local container 'v' that may be invalid.\n", errout.str());
        ...
        check("struct A {\n"
                ...
                "}\n",
              true);
        ASSERT_EQUALS("[test.cpp:7] -> [test.cpp:8] -> [test.cpp:5] -> [test.cpp:9]: (error) Using object that points to local variable 'v' that may be invalid.\n", errout.str());
        ...
        check("struct A {\n"
                ...
                "}\n",
              true);
        ASSERT_EQUALS("[test.cpp:6] -> [test.cpp:7] -> [test.cpp:8] -> [test.cpp:5] -> [test.cpp:9]: (error) Using object that points to local variable 'v' that may be invalid.\n", errout.str());
    }
