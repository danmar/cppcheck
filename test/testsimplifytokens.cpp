...
private:
    ...
    void simplifyAssignmentInFunctionCall()
    {
        ...
        ASSERT_EQUALS("; hs = ( xyz_t ) { h . centerX , h . centerY , 1 + index } ; putInput ( hs , 1 ) ;",
                      tok(";putInput(hs = (xyz_t) { h->centerX, h->centerY, 1 + index }, 1);"));
    }
    ...
    void simplifyCompoundAssignment()
    {
        ...
        ASSERT_EQUALS("void foo ( ) { switch ( n ) { case 0 : ; x = x + y ; break ; } }",
                      tok("void foo() { switch (n) { case 0: x += y; break; } }"));
    ...
    void iftruefalse()
    {
...

        {
            ...
            const char code2[] =
                " void f ( ) { int a ; bool use ; use = false ; { if ( bb ) { a = 1 ; } } int c ; c = 1 ; }";
            ASSERT_EQUALS(tok(code2), tok(code1));
        }
        ...
        {
            const char code1[] =
                "void f() { int a; bool use = true; if( use ) a=0; else if( bb ) a=1; else if( cc ) a=33; else { gg = 0; } int c=1; }";
            const char code2[] = "void f ( ) { }";
    ...
    void parenthesesVar()
    {
        ...
        ASSERT_EQUALS("void f ( ) { DIR * f ; f = opendir ( dirname ) ; if ( closedir ( f ) ) { } }",
                      tok("void f(){DIR * f = opendir(dirname);if (closedir(f)){}}"));
    ...
    void removePostIncrement()
    {
        const char code[] = "void f(int &c)\n"
                            ...
                            "}\n";
        TODO_ASSERT_EQUALS(
            "void f ( int & c ) { c = 3 ; { ; } ; }", "void f ( int & c ) { c = 1 ; { c ++ ; } c ++ ; }", tok(code));
    }
    ...
    void sizeof5()
    {
        ...
        expected << "{ const char * names [ 2 ] ; for ( int i = 0 ; i != " << sizeofFromTokenizer("*")
                 << " ; i ++ ) { } }";
    ...
    void sizeof9()
    {
...

        {
            ...
            std::ostringstream expected;
            expected << "void f ( char * a , char * b , char * c ) { g ( " << sizeofFromTokenizer("*") << " , "
                     << sizeofFromTokenizer("*") << " , " << sizeofFromTokenizer("*") << " ) ; }";
            ASSERT_EQUALS(expected.str(), tok(code));
        }

        {
            const char code[] = "void f(char a,char b, char c)"
                                "{g(sizeof(a),sizeof(b),sizeof(c));}";
            std::ostringstream expected;
            expected << "void f ( char a , char b , char c ) { g ( " << sizeofFromTokenizer("char") << " , "
                     << sizeofFromTokenizer("char") << " , " << sizeofFromTokenizer("char") << " ) ; }";
            ASSERT_EQUALS(expected.str(), tok(code));
        }

        {
            const char code[] = "void f(const char *a,const char *b, const char *c)"
                                "{g(sizeof(a),sizeof(b),sizeof(c));}";
            std::ostringstream expected;
            expected << "void f ( const char * a , const char * b , const char * c ) { g ( " << sizeofFromTokenizer("*")
                     << " , " << sizeofFromTokenizer("*") << " , " << sizeofFromTokenizer("*") << " ) ; }";
            ASSERT_EQUALS(expected.str(), tok(code));
        }

        {
            const char code[] = "void f(char a[10],char b[10], char c[10])"
                                "{g(sizeof(a),sizeof(b),sizeof(c));}";
            std::ostringstream expected;
            expected << "void f ( char a [ 10 ] , char b [ 10 ] , char c [ 10 ] ) { g ( " << sizeofFromTokenizer("*")
                     << " , " << sizeofFromTokenizer("*") << " , " << sizeofFromTokenizer("*") << " ) ; }";
            ASSERT_EQUALS(expected.str(), tok(code));
        }
    ...
    void ifassign1()
    {
        ...
        ASSERT_EQUALS("void f ( ) { A ( ) a = b ; if ( a ) { ; } }",
                      simplifyIfAndWhileAssign("void f() { A() if(a=b); }"));
        ASSERT_EQUALS("void foo ( int a ) { a = b ( ) ; if ( a >= 0 ) { ; } }",
                      tok("void foo(int a) {if((a=b())>=0);}"));
    ...
    void whileAssign1()
    {
        ASSERT_EQUALS("{ a = b ; while ( a ) { b = 0 ; a = b ; } }",
                      simplifyIfAndWhileAssign("{while(a=b) { b = 0; }}"));
        ASSERT_EQUALS("{ a . b = c ; while ( a . b ) { c = 0 ; a . b = c ; } }",
                      simplifyIfAndWhileAssign("{while(a.b=c) { c=0; }}"));
        ASSERT_EQUALS("{ "
    ...
    void whileAssign4()
    {
        ...
        ASSERT_EQUALS("{ m = q . push < Message > ( x ) ; while ( ! m ) { m = q . push < Message > ( x ) ; } }",
                      tokenizer.tokens()->stringifyList(nullptr, false));
    ...
    void doWhileAssign()
    {
        ...
        ASSERT_EQUALS("{ do { a . a = 0 ; a . b = c ; } while ( a . b ) ; }",
                      simplifyIfAndWhileAssign("{ do { a.a = 0; } while(a.b=c); }"));
        ASSERT_EQUALS("{ "
                      "struct hfs_bnode * node ; "
                      "struct hfs_btree * tree ; "
        ...
        // #4911
        ASSERT_EQUALS("void foo ( ) { do { current = f ( ) ; } while ( ( current ) != NULL ) ; }",
                      simplifyIfAndWhileAssign("void foo() { do { } while((current=f()) != NULL); }"));
    }
    ...
    void not1()
    {
        ...
        ASSERT_EQUALS("int foo ( not i ) { return g ( i ) ; }",
                      tok("int foo(not i) { return g(i); }", "test.c", false));
    }

    void and1()
    {
        ASSERT_EQUALS("void f ( ) { if ( p && q ) { ; } }", tok("void f() { if (p and q) ; }", "test.c", false));
        ...
        ASSERT_EQUALS("void f ( ) { if ( p && ! q ) { ; } }", tok("void f() { if (p and not q) ; }", "test.c", false));

        ASSERT_EQUALS("void f ( ) { r = a && b ; }", tok("void f() { r = a and b; }", "test.c", false));
    ...
    void or1()
    {
        ASSERT_EQUALS("void f ( ) { if ( p || q ) { ; } }", tok("void f() { if (p or q) ; }", "test.c", false));
        ...
        ASSERT_EQUALS("void f ( ) { if ( p || ! q ) { ; } }", tok("void f() { if (p or not q) ; }", "test.c", false));

        ASSERT_EQUALS("void f ( ) { r = a || b ; }", tok("void f() { r = a or b; }", "test.c", false));
    ...
    void comma_keyword()
    {
...

        {
            const char code[] = "void foo()\n"
                                ...
                                "}\n";
            // delete a; b; c; would be better but this will do too
            ASSERT_EQUALS("void foo ( ) { char * a ; char * b ; char * c ; if ( x ) { delete a ; b , c ; } }",
                          tok(code));
        }
...

        {
            const char code[] = "void f()\n"
                                ...
                                "    char *ptrs[BUFSIZ], **pp;\n"
                                "}\n";
            ASSERT_EQUALS("void f ( ) { char buf [ BUFSIZ ] ; char * * p ; char * ptrs [ BUFSIZ ] ; char * * pp ; }",
                          tok(code));
        }
    ...
    void calculations()
    {
        ...
        ASSERT_EQUALS("x ( 0 & 4 != 1 ) ;", tok("x(4%1<<1&4!=1);")); // #4931 (can be simplified further but it's not a
                                                                     // problem)
    ...
    void simplifyCalculations()
    {
        ...
        ASSERT_EQUALS("void foo ( ) { if ( b ) { } }", tok("void foo ( ) { if (b + 0) { } }"));
        ASSERT_EQUALS("void foo ( ) { if ( b ) { } }", tok("void foo ( ) { if (0 + b) { } }"));
        ASSERT_EQUALS("void foo ( ) { if ( b ) { } }", tok("void foo ( ) { if (b - 0) { } }"));
        ASSERT_EQUALS("void foo ( ) { if ( b ) { } }", tok("void foo ( ) { if (b * 1) { } }"));
        ASSERT_EQUALS("void foo ( ) { if ( b ) { } }", tok("void foo ( ) { if (1 * b) { } }"));
        ...
        // ticket #3093
        ASSERT_EQUALS("int f ( ) { return 15 ; }", tok("int f() { int a = 10; int b = 5; return a + b; }"));
        ASSERT_EQUALS("int f ( ) { return a ; }", tok("int f() { return a * 1; }"));
        ASSERT_EQUALS("int f ( int a ) { return 0 ; }", tok("int f(int a) { return 0 * a; }"));
        ...
        ASSERT_EQUALS("int foo ( ) { return 1 ; }", tok("int foo ( ) { int i; int j; i = 1 || j; return i; }"));

        ASSERT_EQUALS("int foo ( ) { return 0 ; }",
                      tok("int foo ( ) { int i; int j; i = 0 && j; return i; }")); // ticket #3576 - False positives in
                                                                                   // boolean expressions

        // ticket #3723 - Simplify condition (0 && a < 123)
        ASSERT_EQUALS("( 0 ) ;", tok("( 0 && a < 123 );"));
        ASSERT_EQUALS("( 0 ) ;", tok("( 0 && a[123] );"));
    ...
    {
        {
            ...
            ASSERT_EQUALS("void f ( int n ) { if ( n ) { exit ( 0 ) ; } foo ( ) ; }",
                          tokWithStdLib("void f(int n) { if (n) { exit(0); } foo(); }"));
            ASSERT_EQUALS(
                "void f ( ) { exit ( 0 ) ; }",
                tokWithStdLib(
            ...
            ASSERT_EQUALS(
                "int f ( int n ) { switch ( n ) { case 0 : ; exit ( 0 ) ; default : ; exit ( 0 ) ; } exit ( 0 ) ; }",
                tokWithStdLib(
                    "int f(int n) { switch (n) {case 0: exit(0); n*=2; default: exit(0); n*=6;} exit(0); foo();}"));
            // ticket #3132
            ASSERT_EQUALS("void f ( int i ) { goto label ; { label : ; exit ( 0 ) ; } }",
                          tokWithStdLib("void f (int i) { goto label; switch(i) { label: exit(0); } }"));
            // ticket #3148
            ASSERT_EQUALS("void f ( ) { MACRO ( exit ( 0 ) ) }", tokWithStdLib("void f() { MACRO(exit(0)) }"));
            ASSERT_EQUALS("void f ( ) { MACRO ( bar1 , exit ( 0 ) ) }",
                          tokWithStdLib("void f() { MACRO(bar1, exit(0)) }"));
        }

        {
            const char* code = "void f(){ "
                               ...
                               "   } "
                               "}";
            ASSERT_EQUALS("void f ( ) { if ( k > 0 ) { goto label ; } exit ( 0 ) ; { label : ; bar ( ) ; } }",
                          tokWithStdLib(code));
        }
...

        {
            const char* code = "int f() { "
                               ...
                               "exit(0); } exit(0); }";
            ASSERT_EQUALS("int f ( ) { switch ( x ) { case 1 : ; exit ( 0 ) ; case 2 : ; exit ( 0 ) ; } exit ( 0 ) ; }",
                          tokWithStdLib(code));
        }
...

        {
            ...
            const char* expected =
                "void foo ( ) { exit ( 0 ) ; { { label : ; ok ( ) ; } case 3 : ; if ( blah6 ) { boo ( ) ; break ; } } }";
            ASSERT_EQUALS(expected, tokWithStdLib(code));
        }
        ...
        ASSERT_EQUALS("void foo ( ) { exit ( 0 ) ; }", tokWithStdLib("void foo() { do { exit(0); } while (true); }"));
    ...
    void while0()
    {
        ...
        ASSERT_EQUALS("void foo ( ) { }",
                      tok("void foo() { while (false) { switch (n) { case 0: return; default: break; } n*=1; } }"));
    }

    void while0for()
    {
        // for (condition is always false)
        ASSERT_EQUALS("void f ( ) { int i ; for ( i = 0 ; i < 0 ; i ++ ) { } }",
                      tok("void f() { int i; for (i = 0; i < 0; i++) { a; } }"));
        // ticket #3140
        ASSERT_EQUALS("void f ( ) { int i ; for ( i = 0 ; i < 0 ; i ++ ) { } }",
                      tok("void f() { int i; for (i = 0; i < 0; i++) { foo(); break; } }"));
        ASSERT_EQUALS("void f ( ) { int i ; for ( i = 0 ; i < 0 ; i ++ ) { } }",
                      tok("void f() { int i; for (i = 0; i < 0; i++) { foo(); continue; } }"));
        ...
        // #8059
        ASSERT_EQUALS("void f ( ) { int i ; for ( i = 0 ; i < 0 ; ++ i ) { } return i ; }",
                      tok("void f() { int i; for (i=0;i<0;++i){ dostuff(); } return i; }"));
    }

    void duplicateDefinition()
    { // #3565 - wrongly detects duplicate definition
        Tokenizer tokenizer(&settings0, this);
    ...
    {
        ASSERT_EQUALS("void f ( ) { int a ; a ++ ; }", tok("void f() { int a; int &b(a); b++; }"));
        ASSERT_EQUALS("void f ( ) { int a ; a ++ ; }", tok("void f() { int a; int &b = a; b++; }"));
    ...
    {
        ASSERT_EQUALS("{ while ( f ( ) ) { } }", tok("{ while (f() && errno == EINTR) { } }"));
        ASSERT_EQUALS("{ while ( f ( ) ) { } }", tok("{ while (f() && (errno == EINTR)) { } }"));
    }
    ...
    void simplifyStructDecl1()
    {
...

        {
            ...
            const char expected[] =
                "struct Anonymous0 { int a ; } ; static struct Anonymous0 const array [ 3 ] = { 0 } ;";
            ASSERT_EQUALS(expected, tok(code, false));
        }
...

        {
            ...
            const char expected[] =
                "struct Anonymous0 { struct Anonymous1 { } ; struct Anonymous1 def ; } ; struct Anonymous0 abc ;";
            ASSERT_EQUALS(expected, tok(code, false));
        }
        ...
        // ticket #980
        {
            ...
            const char expected[] =
                "void f ( ) { int A ; A = 1 ; int B ; B = 2 ; int C ; C = 3 ; int D ; int E ; E = 5 ; int F ; F = 6 ; }";
            ASSERT_EQUALS(expected, tok(code, false));
        }
    ...
    void simplifyStructDecl2()
    { // ticket #2479 (segmentation fault)
    ...
    void simplifyStructDecl8()
    {
        ...
        ASSERT_EQUALS("enum Anonymous0 { x , y , z } ; enum Anonymous0 d ; d = x ;",
                      tok("enum { x, y, z } d(x);", false));
        ASSERT_EQUALS("enum Anonymous0 { x , y , z } ; enum Anonymous0 e ; e = x ;",
                      tok("enum { x, y, z } e{x};", false));
        ASSERT_EQUALS("struct Anonymous0 { int i ; } ; struct Anonymous0 f ; f = { 0 } ;",
                      tok("struct { int i; } f{0};", false));
        ASSERT_EQUALS("struct Anonymous0 { } ; struct Anonymous0 x ; x = { 0 } ;", tok("struct {} x = {0};", false));
        ASSERT_EQUALS("enum G : short { x , y , z } ; enum G g ; g = x ;",
                      tok("enum G : short { x, y, z } g(x);", false));
        ASSERT_EQUALS("enum H : short { x , y , z } ; enum H h ; h = x ;",
                      tok("enum H : short { x, y, z } h{x};", false));
        ASSERT_EQUALS("enum class I : short { x , y , z } ; enum I i ; i = x ;",
                      tok("enum class I : short { x, y, z } i(x);", false));
        ASSERT_EQUALS("enum class J : short { x , y , z } ; enum J j ; j = x ;",
                      tok("enum class J : short { x, y, z } j{x};", false));
    }
    ...
    void removeUnwantedKeywords()
    {
        ...
        ASSERT_EQUALS("int * * p ;", tok("int * restrict * p;", "test.c"));
        ASSERT_EQUALS("void foo ( float * a , float * b ) ;",
                      tok("void foo(float * restrict a, float * restrict b);", "test.c"));
    ...
    void simplifyFunctorCall() { ASSERT_EQUALS("IncrementFunctor ( ) ( a ) ;", tok("IncrementFunctor()(a);", true)); }
    ...
    void consecutiveBraces()
    {
        ...
        ASSERT_EQUALS("void f ( ) { { scope_lock lock ; foo ( ) ; } { scope_lock lock ; bar ( ) ; } }",
                      tok("void f () { {scope_lock lock; foo();} {scope_lock lock; bar();} }", true));
    }
    ...
    {
        ASSERT_EQUALS(";", tok("namespace ios = boost::iostreams;"));
        ...
        ASSERT_EQUALS(";", tok("using namespace std; namespace ios = boost::iostreams;"));
        ASSERT_EQUALS(
            "namespace NS { boost :: iostreams :: istream foo ( \"foo\" ) ; }",
        ...
        TODO_ASSERT_EQUALS(
            "namespace A { namespace B { void foo ( ) { bar ( A :: B :: ab ( ) ) ; { baz ( A :: a ( ) ) ; } bar ( A :: B :: ab ( ) ) ; } } }",
    ...
    {
        {
            ...
            ASSERT_EQUALS("void f ( ) { int a ; a = 10 ; if ( 10 ) { ; } }", simplifyKnownVariables(code));
        }
    ...
    void simplifyKnownVariables2()
    {
        ...
        ASSERT_EQUALS("void f ( ) { int a ; a = 10 ; a = g ( ) ; if ( a ) { ; } }", simplifyKnownVariables(code));
    }
    ...
    void simplifyKnownVariables3()
    {
        ...
        ASSERT_EQUALS("void f ( ) { int a ; a = 4 ; while ( true ) { break ; a = 10 ; } if ( a ) { ; } }",
    ...
    void simplifyKnownVariables4()
    {
        ...
        ASSERT_EQUALS("void f ( ) { int a ; a = 4 ; if ( g ( a ) ) { ; } }", simplifyKnownVariables(code));
    }
    ...
    void simplifyKnownVariables5()
    {
        ...
        ASSERT_EQUALS("void f ( ) { int a ; a = 4 ; if ( a = 5 ) { ; } }", simplifyKnownVariables(code));
    }
    ...
    void simplifyKnownVariables6()
    {
        ...
        ASSERT_EQUALS("void f ( ) { char str [ 2 ] ; int a ; a = 4 ; str [ 4 ] = 0 ; }", simplifyKnownVariables(code));
    }
    ...
    void simplifyKnownVariables7()
    {
        ...
        ASSERT_EQUALS("void foo ( ) { int i ; i = 24 ; abc [ 22 ] = 1 ; abc [ 24 ] = 2 ; }",
                      simplifyKnownVariables(code));
    }
    ...
    void simplifyKnownVariables8()
    {
        ...
        ASSERT_EQUALS("void foo ( ) { int i ; i = 23 ; abc [ 23 ] = 0 ; }", simplifyKnownVariables(code));
    }
    ...
    void simplifyKnownVariables9()
    {
        ...
        ASSERT_EQUALS("void foo ( ) { int a ; a = 1 ; int b ; b = 2 ; if ( 1 < 2 ) { ; } }",
                      simplifyKnownVariables(code));
    }
    ...
    {
        {
            ...
            TODO_ASSERT_EQUALS(expected1 + " if ( true ) { a ( ) ; } }",
                               expected1 + " if ( b ) { a ( ) ; } }",
                               simplifyKnownVariables(code));
        }
...

        {
            ...
            ASSERT_EQUALS("void f ( ) { int b ; b = 0 ; b = 1 ; for ( int i = 0 ; i < 10 ; i ++ ) { } return 1 ; }",
                          simplifyKnownVariables(code));
        }
    }
    ...
    void simplifyKnownVariables11()
    {
        ...
        ASSERT_EQUALS("int main ( ) { int foo ; foo = 0 ; }", simplifyKnownVariables(code));
    }
    ...
    void simplifyKnownVariables13()
    {
        ...
        ASSERT_EQUALS("void f ( ) { int i ; i = 10 ; while ( -- i ) { } }", simplifyKnownVariables(code));
    }
    ...
    {
        {
            ...
            ASSERT_EQUALS("int main ( ) { int x ; x = 5 ; std :: cout << 10 / 5 << std :: endl ; }",
                          simplifyKnownVariables(code));
        }

        {
            ...
            ASSERT_EQUALS("int main ( ) { int x ; x = 5 ; std :: cout << 5 / ( 5 == 1 ) << std :: endl ; }",
                          simplifyKnownVariables(code));
        }
    }
    ...
    void simplifyKnownVariables17()
    {
        ...
        ASSERT_EQUALS("void f ( ) { char * s ; s = malloc ( 100 ) ; mp_ptr p ; p = s ; p ++ ; }",
                      simplifyKnownVariables(code));
    }
    ...
    void simplifyKnownVariables19()
    {
        ...
        ASSERT_EQUALS("void f ( ) { int i ; i = 0 ; do { if ( i > 0 ) { a ( ) ; } i = b ( ) ; } while ( i != 12 ) ; }",
                      simplifyKnownVariables(code));
    }
    ...
    void simplifyKnownVariables20()
    {
        ...
        ASSERT_EQUALS("void f ( ) { int i ; i = 0 ; if ( x ) { if ( 0 ) { i = 0 ; } } }", simplifyKnownVariables(code));
    }
    ...
    void simplifyKnownVariables21()
    {
        ...
        ASSERT_EQUALS("void foo ( ) { int n ; n = 10 ; for ( int i = 0 ; i < 10 ; ++ i ) { } }",
                      simplifyKnownVariables(code));

        ASSERT_EQUALS("void foo ( int i ) { int n ; n = i ; for ( i = 0 ; i < n ; ++ i ) { } }",
    ...
    void simplifyKnownVariables22()
    {
        // This testcase is related to ticket #1169
        {
            ...
            ASSERT_EQUALS("void foo ( ) { int n ; n = 10 ; i = 10 >> 1 ; }", simplifyKnownVariables(code));
        }
        {
            const char code[] = "void foo()\n"
                                "{\n"
        ...
        }
        {
            ...
            ASSERT_EQUALS("void foo ( ) { int n ; n = 10 ; i = 1 << 10 ; }", simplifyKnownVariables(code));
        }
        {
            const char code[] = "void foo()\n"
                                "{\n"
    ...
    void simplifyKnownVariables23()
    {
        ...
        TODO_ASSERT_EQUALS("void foo ( int x ) "
                           "{"
                           " int a [ 10 ] ; int c ; c = 0 ;"
                           " if ( x ) { a [ 0 ] = 0 ; c = 1 ; }"
                           " else { a [ 0 ] = 0 ; } "
    ...
    {
        {
            ...
            // Current result
            ASSERT_EQUALS("void foo ( char * str ) "
                          "{"
                          " int i ;"
                          " for ( i = 0 ; i < 10 ; ++ i ) {"
                          " if ( * str == 0 ) { goto label ; }"
    ...
    { // #4728 "= x %op%"
        ASSERT_EQUALS("void f ( ) { int y ; y = 34 + z ; }",
                      tokenizeAndStringify("void f() { int x=34; int y=x+z; }", true));
        ASSERT_EQUALS("void f ( ) { int y ; y = 34 - z ; }",
                      tokenizeAndStringify("void f() { int x=34; int y=x-z; }", true));
        ASSERT_EQUALS("void f ( ) { int y ; y = 34 * z ; }",
                      tokenizeAndStringify("void f() { int x=34; int y=x*z; }", true));
        ...
        // #4007
        ASSERT_EQUALS("void f ( ) { }",
                      tokenizeAndStringify("void f() { char *p = 0; int result = p && (!*p); }", true));
        ASSERT_EQUALS("void f ( ) { }",
                      tokenizeAndStringify("void f() { Foo *p = 0; bool b = (p && (p->type() == 1)); }", true));
    }

    void simplifyKnownVariables53()
    { // references
        ASSERT_EQUALS("void f ( ) { int x ; x = abc ( ) ; }",
                      tokenizeAndStringify("void f() { int x; int &ref=x; ref=abc(); }", true));
        ASSERT_EQUALS("void f ( ) { int * p ; p = abc ( ) ; }",
                      tokenizeAndStringify("void f() { int *p; int *&ref=p; ref=abc(); }", true));
    }

    void simplifyKnownVariables54()
    { // #4913
        ASSERT_EQUALS("void f ( int * p ) { * -- p = 0 ; * p = 0 ; }",
                      tokenizeAndStringify("void f(int*p) { *--p=0; *p=0; }", true));
    }

    void simplifyKnownVariables55()
    { // pointer alias
        ASSERT_EQUALS("void f ( ) { int a ; if ( a > 0 ) { } }",
                      tokenizeAndStringify("void f() { int a; int *p=&a; if (*p>0) {} }", true));
        ASSERT_EQUALS("void f ( ) { int a ; struct AB ab ; ab . a = & a ; if ( a > 0 ) { } }",
                      tokenizeAndStringify("void f() { int a; struct AB ab; ab.a = &a; if (*ab.a>0) {} }", true));
        ASSERT_EQUALS("void f ( ) { int a ; if ( x > a ) { } }",
                      tokenizeAndStringify("void f() { int a; int *p=&a; if (x>*p) {} }", true));
    }

    void simplifyKnownVariables56()
    { // ticket #5301 - >>
        ASSERT_EQUALS("void f ( ) { int a ; a = 0 ; int b ; b = 0 ; * p >> a >> b ; return a / b ; }",
                      tokenizeAndStringify("void f() { int a=0,b=0; *p>>a>>b; return a/b; }", true));
    }

    void simplifyKnownVariables57()
    { // #4724
        ASSERT_EQUALS("unsigned long long x ; x = 9223372036854775808UL ;",
                      tokenizeAndStringify("unsigned long long x = 1UL << 63 ;", true));
        ASSERT_EQUALS("long long x ; x = -9223372036854775808L ;",
                      tokenizeAndStringify("long long x = 1L << 63 ;", true));
    }

    void simplifyKnownVariables58()
    { // #5268
    ...
    void simplifyKnownVariablesBailOutAssign3()
    { // #4395 - nested assignments
        const char code[] = "void f() {\n"
                            "    int *p = 0;\n"
    ...
    void simplifyKnownVariablesGlobalVars()
    {
        ...
        const char code[] = "static int x;"
                            ...
                            "    while (!x) { dostuff(); }"
                            "}";
        ASSERT_EQUALS("static int x ; void f ( ) { x = 123 ; while ( ! x ) { dostuff ( ) ; } }",
                      tokenizeAndStringify(code, true));
    }
    ...
    void simplifyKnownVariablesPointerAliasFunctionCall()
    { // #7440
        const char code[] = "int main() {\n"
    ...
    void simplifyCasts7() { ASSERT_EQUALS("str = malloc ( 3 )", tok("str=(char **)malloc(3)")); }

    void simplifyCasts8() { ASSERT_EQUALS("ptr1 = ptr2", tok("ptr1=(int *   **)ptr2")); }
    ...
    void simplifyCasts10() { ASSERT_EQUALS("; ( * f ) ( p ) ;", tok("; (*(void (*)(char *))f)(p);")); }

    void simplifyCasts11() { ASSERT_EQUALS("; x = 0 ;", tok("; *(int *)&x = 0;")); }
    ...
    void simplifyCasts15()
    { // #5996 - don't remove cast in 'a+static_cast<int>(b?60:0)'
        ASSERT_EQUALS("a + ( b ? 60 : 0 ) ;", tok("a + static_cast<int>(b ? 60 : 0);"));
    }

    void simplifyCasts16()
    { // #6278
        ASSERT_EQUALS("Get ( pArray ) ;", tok("Get((CObject*&)pArray);"));
    }

    void simplifyCasts17()
    { // #6110 - don't remove any parentheses in 'a(b)(c)'
        ASSERT_EQUALS("{ if ( a ( b ) ( c ) >= 3 ) { } }", tok("{ if (a(b)(c) >= 3) { } }"));
    }
    ...
    {
        const char code[] = "void f( Foo &foo, Foo *foo2 ) {\n"
                            "const int a = 45;\n"
                            "foo.a=a+a;\n"
                            "foo2->a=a;\n"
                            "}";
    ...
    {
        const char code[] = "static const char str[] = \"abcd\";\n"
                            "static const unsigned int SZ = sizeof(str);\n"
                            "void f() {\n"
                            "a = SZ;\n"
                            "}\n";
        const char expected[] = "static const char str [ 5 ] = \"abcd\" ; void f ( ) { a = 5 ; }";
        ASSERT_EQUALS(expected, tok(code));
    }
