...
private:
    ...
    void run() override {
        ...
        TEST_CASE(getConfigs23); // #1059
        TEST_CASE(getConfigs24); // #1059
        TEST_CASE(getConfigs25); // #1059
        TEST_CASE(getConfigs26); // #1059
        TEST_CASE(getConfigs27); // #1059
