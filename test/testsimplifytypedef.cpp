...
#define tok(...) tok_(__FILE__, __LINE__, __VA_ARGS__)
    std::string tok_(const char* file, int line, const char code[], bool simplify = true, cppcheck::Platform::PlatformType type = cppcheck::Platform::Native, bool debugwarnings = true) {
        errout.str("");
...
#define checkSimplifyTypedef(code) checkSimplifyTypedef_(code, __FILE__, __LINE__)
    ...
    void simplifyTypedef14() {
        ...
        // Tokenize and check output..
        TODO_ASSERT_THROW(tok(code, true, cppcheck::Platform::Native, false), InternalError); // TODO: Do not throw exception
        //ASSERT_EQUALS("", errout.str());
    }
    ...
    void simplifyTypedef62() { // ticket #2082
        ...
        ASSERT_EQUALS(expected2, tok(code2, false, cppcheck::Platform::Native, false));
        ASSERT_EQUALS("", errout.str());
        ...
        ASSERT_EQUALS(expected3, tok(code3, false, cppcheck::Platform::Native, false));
        ASSERT_EQUALS("", errout.str());
        ...
        ASSERT_EQUALS(expected4, tok(code4, false, cppcheck::Platform::Native, false));
        ASSERT_EQUALS("", errout.str());
    }
    ...
    void simplifyTypedef65() { // ticket #2314
        const char code[] = "typedef BAR<int> Foo;\n"
                            ...
                            "    return b > Foo(10);\n"
                            "}";
        const std::string actual(tok(code, true, cppcheck::Platform::Native, false));
    ...
    void simplifyTypedef75() { // ticket #2426
        ...
        ASSERT_EQUALS(";", tok(code, true, cppcheck::Platform::Native, false));
        ASSERT_EQUALS("", errout.str());
    }
    ...
    void simplifyTypedef76() { // ticket #2453 segmentation fault
        ...
        ASSERT_EQUALS(expected, tok(code, true, cppcheck::Platform::Native, false));
        ASSERT_EQUALS("", errout.str());
    }
    ...
    void simplifyTypedef137() { // #10054 debug: Executable scope 'x' with unknown function.
        {
            ...
            ASSERT_EQUALS(exp, tok(code, true, cppcheck::Platform::Native, true));
            ASSERT_EQUALS("", errout.str());
        }
        {
        ...
        }
        {
            ...
            const char act[]  = "namespace external { "
                                ...
                                "} "
                                "struct external :: ns1 :: B<1> { } ;";
            TODO_ASSERT_EQUALS(exp, act, tok(code, true, cppcheck::Platform::Native, true));
