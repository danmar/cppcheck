...
private:
    ...
    void assign13()
    { // #4237: FP. char *&ref=p; p=malloc(10); free(ref);
        check("void f() {\n"
              "    char *p;\n"
              "    char * &ref = p;\n"
              "    p = malloc(10);\n"
    ...
    void return5()
    { // ticket #6397 - conditional allocation/deallocation and conditional return
        // avoid false positives
...
private:
    ...
    void heapDoubleFree()
    {
        ...
        check("void f() {"
              ...
              "  HeapFree(MyHeap, 0, b);"
              "}");
        TODO_ASSERT_EQUALS("[test.c:1] (error) Resource leak: MyHeap", "", errout.str());
