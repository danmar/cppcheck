...
public:
    TestClangImport() : TestFixture("TestClangImport") {}
...
private:
    ...
    void caseStmt1()
    {
        ...
        ASSERT_EQUALS("void foo ( int x@1 ) { switch ( x@1 ) { case 16 : case 32 : x@1 = 123 ; break ; } }",
                      parse(clang));
    }
    ...
    void classTemplateDecl2()
    {
        ...
        ASSERT_EQUALS(
            "class C { int foo ( ) { return 0 ; } C ( ) { } C ( const C<int> & ) = default ; C ( C<int> && ) = default ; } ;",
            parse(clang));
    }
    ...
    void cxxForRangeStmt1()
    {
        ...
        ASSERT_EQUALS("void foo ( ) { for ( char c1@1 : hello ) { } }", parse(clang));
    }
    ...
    void cxxForRangeStmt2()
    {
        ...
        ASSERT_EQUALS("void foo ( ) { for ( int v@1 : values ) { } }", parse(clang));
    }
    ...
    void cxxMethodDecl1()
    {
        const char clang[] =
            ...
            "  `-CompoundStmt 0x0 <>";
        ASSERT_EQUALS(
            "_Bool analyzeFile ( const std :: string & buildDir@1 , const std :: string & sourcefile@2 , const std :: string & cfg@3 , unsigned long long checksum@4 , std::list<ErrorLogger::ErrorMessage> * errors@5 ) { }",
            parse(clang));
    }

    void cxxMethodDecl2()
    { // "unexpanded" template method
        const char clang[] =
    ...
    void cxxMethodDecl4()
    {
        ...
        ASSERT_EQUALS("struct char_traits<char> { static char * move ( char * __s1@1 ) { } } ;", parse(clang));
    }
    ...
    void cxxNewExpr1()
    {
        ...
        ASSERT_EQUALS("int * i@1 = new int ; int * j@2 = new int [ 100 ] ;", parse(clang));
    }
    ...
    void cxxNewExpr2()
    {
        ...
        ASSERT_EQUALS("struct S * f ( ) { return new S ( ) ; }", parse(clang));
    }
    ...
    void cxxRecordDeclDerived()
    {
        ...
        ASSERT_EQUALS("struct base { static const bool value@1 = false ; } ; struct derived : public base { } ;",
                      parse(clang));
    }
    ...
    void cxxStaticCastExpr2()
    {
        ...
        ASSERT_EQUALS(
            "int a@1 = static_cast<structstd::_Rb_tree_iterator<structstd::pair<constclassstd::__cxx11::basic_string<char>,structLibrary::AllocFunc>>&&> ( <NoName> ) ;",
            parse(clang));
    }
    ...
    void cxxStaticCastExpr3()
    {
        ...
        ASSERT_EQUALS(
            "struct char_traits<char> { typedef char char_type ; char_traits<char>::char_type * assign ( char_traits<char>::char_type * __s@1 ) { return static_cast<char_traits<char>::char_type*> ( __s@1 ) ; } } ;",
            parse(clang));
    }
    ...
    void memberExpr()
    {
        ...
        ASSERT_EQUALS("struct S { int x@1 ; } ; int foo ( struct S s@2 ) { return s@2 . x@1 ; }", parse(clang));
    }
    ...
    void namespaceDecl1()
    {
        ...
        ASSERT_EQUALS("namespace x { int var@1 ; }", parse(clang));
    }
    ...
    void namespaceDecl2()
    {
        ...
        ASSERT_EQUALS("namespace std { int x@1 ; }", parse(clang));
    }
    ...
    void recordDecl()
    {
        ...
        ASSERT_EQUALS("struct S { int x@1 ; int y@2 ; } ;", parse(clang));
    }
    ...
    void switchStmt()
    {
        ...
        ASSERT_EQUALS("void foo ( int x@1 ) { switch ( x@1 ) { } ; }", parse(clang));
    }
    ...
    void vardecl1()
    {
        ...
        ASSERT_EQUALS("int a@1 = 1 ; int b@2 = a@1 ;", parse(clang));
    }
    ...
    void vardecl2()
    {
        ...
        ASSERT_EQUALS("int [10] a@1 ; void foo ( ) { a@1 [ 0 ] = 0 ; }", parse(clang));
    }
    ...
    void whileStmt1()
    {
        ...
        ASSERT_EQUALS("void foo ( ) { while ( 0 ) { ; } }", parse(clang));
    }
