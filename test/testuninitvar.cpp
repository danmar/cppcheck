...
private:
    ...
    void uninitvar_return()
    {
        ...
        // Ticket #6341- False negative
        {
            ...
            checkUninitVar("void setvalue(int &x) {\n"
                           "  x = 0;\n"
                           "  return 123;\n"
                           "}\n"
                           "int f() {\n"
    ...
    void uninitvar_ternaryexpression()
    { // #4683
