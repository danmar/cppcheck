...
#define check(...) check_(__FILE__, __LINE__, __VA_ARGS__)
    ...
    void simple1() {
        ...
        check("class Fred\n"
              ...
              "    int i;\n"
              "};");
        ASSERT_EQUALS("[test.cpp:1]: (style) The class 'Fred' does not declare a constructor although it has private member variables.\n", errout.str());
        ...
        check("struct Fred\n"
              ...
              "    int i;\n"
              "};");
        ASSERT_EQUALS("[test.cpp:1]: (style) The struct 'Fred' does not declare a constructor although it has private member variables.\n", errout.str());
    }
    ...
    void simple8() {
        ...
        ASSERT_EQUALS("[test.cpp:2]: (style) The class 'Barney' does not declare a constructor although it has private member variables.\n"
                      "[test.cpp:3]: (style) The class 'Wilma' does not declare a constructor although it has private member variables.\n", errout.str());
    }
