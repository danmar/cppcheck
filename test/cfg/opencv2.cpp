...
//
// Usage:
// $ cppcheck --check-library --library=opencv2 --enable=style,performance,portability,warning,information --inconclusive --error-exitcode=1 --disable=missingInclude --inline-suppr test/cfg/opencv2.cpp
// =>
