...
//
// Usage:
// $ cppcheck --check-library --library=kde --enable=style,performance,portability,warning,information --inconclusive --error-exitcode=1 --disable=missingInclude --inline-suppr test/cfg/kde.cpp
// =>
