...
//
// Usage:
// $ cppcheck --check-library --library=windows --enable=information --error-exitcode=1 --inline-suppr
// --suppress=missingIncludeSystem test/cfg/windows.cpp
// =>
...
error_t uninitvar__strncpy_s_l(char* strDest,
...
// errno_t _strncpy_s_l(char *strDest, size_t numberOfElements, const char *strSource, size_t count, _locale_t locale);
error_t nullPointer__strncpy_s_l(char* strDest,
                                 size_t numberOfElements,
                                 const char* strSource,
                                 size_t count,
                                 _locale_t locale)
