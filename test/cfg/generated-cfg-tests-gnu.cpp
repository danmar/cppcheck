...
void test__backtrace_symbols__noreturn()
{
    ...
    if (cond) {
        x=100;
        result = backtrace_symbols(arg1, arg2);
    }
    // cppcheck-suppress shiftTooManyBits
    x = 1 << x;
}
...
void test__backtrace_symbols_fd__noreturn()
{
    ...
    if (cond) {
        x=100;
        backtrace_symbols_fd(arg1, arg2, arg3);
    }
    // cppcheck-suppress shiftTooManyBits
    x = 1 << x;
}
...
void test__ecvt_r__noreturn()
{
    ...
    if (cond) {
        x=100;
        ecvt_r(arg1, arg2, arg3, arg4, arg5, arg6);
    }
    // cppcheck-suppress shiftTooManyBits
    x = 1 << x;
}
...
void test__fcvt_r__noreturn()
{
    ...
    if (cond) {
        x=100;
        fcvt_r(arg1, arg2, arg3, arg4, arg5, arg6);
    }
    // cppcheck-suppress shiftTooManyBits
    x = 1 << x;
}
...
void test__qecvt_r__noreturn()
{
    ...
    if (cond) {
        x=100;
        qecvt_r(arg1, arg2, arg3, arg4, arg5, arg6);
    }
    // cppcheck-suppress shiftTooManyBits
    x = 1 << x;
}
...
void test__qfcvt_r__noreturn()
{
    ...
    if (cond) {
        x=100;
        qfcvt_r(arg1, arg2, arg3, arg4, arg5, arg6);
    }
    // cppcheck-suppress shiftTooManyBits
    x = 1 << x;
}
...
void test__canonicalize_file_name__noreturn()
{
    ...
    if (cond) {
        x=100;
        result = canonicalize_file_name(arg1);
    }
    // cppcheck-suppress shiftTooManyBits
    x = 1 << x;
}
...
void test__memmem__noreturn()
{
    ...
    if (cond) {
        x=100;
        result = memmem(arg1, arg2, arg3, arg4);
    }
    // cppcheck-suppress shiftTooManyBits
    x = 1 << x;
}
...
void test__epoll_wait__noreturn()
{
    ...
    if (cond) {
        x=100;
        epoll_wait(arg1, arg2, arg3, arg4);
    }
    // cppcheck-suppress shiftTooManyBits
    x = 1 << x;
}
...
void test__epoll_pwait__noreturn()
{
    ...
    if (cond) {
        x=100;
        epoll_pwait(arg1, arg2, arg3, arg4, arg5);
    }
    // cppcheck-suppress shiftTooManyBits
    x = 1 << x;
}
