...
int main() {
    ...
    test__accept__arg3__notnull();
    test__accept__arg3__notuninit();
    test__accept__arg4__notuninit();
    test__atoq__noreturn();
    test__atoq__useretval();
    test__atoq__arg1__notnull();
    test__atoq__arg1__notuninit();
    test__strndupa__noreturn();
    test__strndupa__useretval();
    test__strndupa__arg1__notnull();
    test__strndupa__arg1__notuninit();
    test__strndupa__arg2__notuninit();
    test__strsep__noreturn();
    test__strsep__useretval();
    test__strsep__arg1__notuninit();
    test__strsep__arg2__notnull();
    test__strsep__arg2__notuninit();
    test__strdupa__noreturn();
    test__strdupa__useretval();
    test__strdupa__arg1__notnull();
    test__strdupa__arg1__notuninit();
    test__backtrace__noreturn();
    test__backtrace__arg1__notnull();
    test__backtrace__arg2__notuninit();
    test__backtrace_symbols__noreturn();
    test__backtrace_symbols__useretval();
    test__backtrace_symbols__arg1__notnull();
    test__backtrace_symbols__arg1__notuninit();
    test__backtrace_symbols__arg2__notuninit();
    test__backtrace_symbols_fd__noreturn();
    test__backtrace_symbols_fd__arg1__notnull();
    test__backtrace_symbols_fd__arg1__notuninit();
    test__backtrace_symbols_fd__arg2__notuninit();
    test__backtrace_symbols_fd__arg3__notuninit();
    ...
    test__qfcvt__noreturn();
    test__qfcvt__arg1__notuninit();
    test__qfcvt__arg2__notuninit();
    test__qfcvt__arg3__notnull();
    test__qfcvt__arg4__notnull();
    test__qgcvt__noreturn();
    test__qgcvt__arg1__notuninit();
    test__qgcvt__arg2__notuninit();
    test__qgcvt__arg3__notnull();
    test__ecvt_r__noreturn();
    test__ecvt_r__pure();
    test__ecvt_r__arg1__notuninit();
    test__ecvt_r__arg2__notuninit();
    test__ecvt_r__arg3__notnull();
    test__ecvt_r__arg4__notnull();
    test__ecvt_r__arg5__notnull();
    test__ecvt_r__arg6__notuninit();
    test__fcvt_r__noreturn();
    test__fcvt_r__pure();
    test__fcvt_r__arg1__notuninit();
    test__fcvt_r__arg2__notuninit();
    test__fcvt_r__arg3__notnull();
    test__fcvt_r__arg4__notnull();
    test__fcvt_r__arg5__notnull();
    test__fcvt_r__arg6__notuninit();
    test__qecvt_r__noreturn();
    test__qecvt_r__pure();
    test__qecvt_r__arg1__notuninit();
    test__qecvt_r__arg2__notuninit();
    test__qecvt_r__arg3__notnull();
    test__qecvt_r__arg4__notnull();
    test__qecvt_r__arg5__notnull();
    test__qecvt_r__arg6__notuninit();
    test__qfcvt_r__noreturn();
    test__qfcvt_r__pure();
    test__qfcvt_r__arg1__notuninit();
    test__qfcvt_r__arg2__notuninit();
    test__qfcvt_r__arg3__notnull();
    test__qfcvt_r__arg4__notnull();
    test__qfcvt_r__arg5__notnull();
    test__qfcvt_r__arg6__notuninit();
    test__strcasestr__noreturn();
    test__strcasestr__useretval();
    test__strcasestr__pure();
    test__strcasestr__leakignore();
    test__strcasestr__arg1__notnull();
    test__strcasestr__arg1__notuninit();
    test__strcasestr__arg2__notnull();
    test__strcasestr__arg2__notuninit();
    test__getresuid__noreturn();
    test__getresuid__pure();
    test__getresuid__leakignore();
    test__getresuid__arg1__notnull();
    test__getresuid__arg2__notnull();
    test__getresuid__arg3__notnull();
    test__getresgid__noreturn();
    test__getresgid__pure();
    test__getresgid__leakignore();
    test__getresgid__arg1__notnull();
    test__getresgid__arg2__notnull();
    test__getresgid__arg3__notnull();
    test__setresuid__noreturn();
    test__setresuid__leakignore();
    test__setresuid__arg1__notuninit();
    test__setresuid__arg2__notuninit();
    test__setresuid__arg3__notuninit();
    test__setresgid__noreturn();
    test__setresgid__leakignore();
    test__setresgid__arg1__notuninit();
    test__setresgid__arg2__notuninit();
    test__setresgid__arg3__notuninit();
    test__inet_aton__noreturn();
    test__inet_aton__leakignore();
    test__inet_aton__arg1__notnull();
    test__inet_aton__arg1__notuninit();
    test__inet_aton__arg2__notnull();
    test__inet_addr__noreturn();
    test__inet_addr__leakignore();
    test__inet_addr__arg1__notnull();
    test__inet_addr__arg1__notuninit();
    test__inet_network__noreturn();
    test__inet_network__leakignore();
    test__inet_network__arg1__notnull();
    test__inet_network__arg1__notuninit();
    test__inet_ntoa__noreturn();
    test__inet_ntoa__leakignore();
    test__inet_ntoa__arg1__notuninit();
    test__inet_makeaddr__noreturn();
    test__inet_makeaddr__leakignore();
    test__inet_makeaddr__arg1__notuninit();
    test__inet_makeaddr__arg2__notuninit();
    test__inet_lnaof__noreturn();
    test__inet_lnaof__leakignore();
    test__inet_lnaof__arg1__notuninit();
    test__inet_netof__noreturn();
    test__inet_netof__leakignore();
    test__inet_netof__arg1__notuninit();
    test__inet_pton__noreturn();
    test__inet_pton__leakignore();
    test__inet_pton__arg1__notuninit();
    test__inet_pton__arg2__notnull();
    test__inet_pton__arg2__notuninit();
    test__inet_pton__arg3__notnull();
    test__inet_ntop__noreturn();
    test__inet_ntop__leakignore();
    test__inet_ntop__arg1__notuninit();
    test__inet_ntop__arg2__notnull();
    test__inet_ntop__arg2__notuninit();
    test__inet_ntop__arg3__notnull();
    test__inet_ntop__arg4__notuninit();
    test__canonicalize_file_name__noreturn();
    test__canonicalize_file_name__useretval();
    test__canonicalize_file_name__leakignore();
    test__canonicalize_file_name__arg1__notnull();
    test__execvpe__noreturn();
    test__execvpe__leakignore();
    test__execvpe__arg1__notnull();
    test__execvpe__arg1__notuninit();
    test__execvpe__arg2__notuninit();
    test__execvpe__arg3__notuninit();
    test__mkostemp__noreturn();
    test__mkostemp__leakignore();
    test__mkostemp__arg1__notnull();
    test__mkostemp__arg1__notuninit();
    test__mkostemp__arg2__notuninit();
    test__mkstemps__noreturn();
    test__mkstemps__leakignore();
    test__mkstemps__arg1__notnull();
    test__mkstemps__arg1__notuninit();
    test__mkstemps__arg2__notuninit();
    test__mkostemps__noreturn();
    test__mkostemps__leakignore();
    test__mkostemps__arg1__notnull();
    test__mkostemps__arg1__notuninit();
    test__mkostemps__arg2__notuninit();
    test__mkostemps__arg3__notuninit();
    test__memmem__noreturn();
    test__memmem__useretval();
    test__memmem__leakignore();
    test__memmem__arg1__notnull();
    test__memmem__arg1__notuninit();
    test__memmem__arg2__notuninit();
    test__memmem__arg3__notnull();
    test__memmem__arg3__notuninit();
    test__memmem__arg4__notuninit();
    test__memrchr__noreturn();
    test__memrchr__leakignore();
    test__memrchr__arg1__notnull();
    test__memrchr__arg1__notuninit();
    test__memrchr__arg2__notbool();
    test__memrchr__arg2__notuninit();
    test__memrchr__arg3__notbool();
    test__rawmemchr__noreturn();
    test__rawmemchr__leakignore();
    test__rawmemchr__arg1__notnull();
    test__rawmemchr__arg1__notuninit();
    test__rawmemchr__arg2__notbool();
    test__rawmemchr__arg2__notuninit();
    test__ffsl__noreturn();
    test__ffsl__useretval();
    test__ffsl__leakignore();
    test__ffsl__arg1__notuninit();
    test__ffsll__noreturn();
    test__ffsll__useretval();
    test__ffsll__leakignore();
    test__ffsll__arg1__notuninit();
    test__strchrnul__noreturn();
    test__strchrnul__useretval();
    test__strchrnul__leakignore();
    test__strchrnul__arg1__notnull();
    test__strchrnul__arg1__notuninit();
    test__strchrnul__arg2__notuninit();
    test__prlimit__noreturn();
    test__prlimit__leakignore();
    test__prlimit__arg1__notuninit();
    test__prlimit__arg2__notuninit();
    test__prlimit__arg3__notuninit();
    test__epoll_create__noreturn();
    test__epoll_create__arg1__notbool();
    test__epoll_create__arg1__notuninit();
    test__epoll_create1__noreturn();
    test__epoll_create1__arg1__notbool();
    test__epoll_create1__arg1__notuninit();
    test__epoll_ctl__noreturn();
    test__epoll_ctl__arg1__notbool();
    test__epoll_ctl__arg1__notuninit();
    test__epoll_ctl__arg2__notbool();
    test__epoll_ctl__arg2__notuninit();
    test__epoll_ctl__arg3__notbool();
    test__epoll_ctl__arg3__notuninit();
    test__epoll_ctl__arg4__notbool();
    test__epoll_ctl__arg4__notnull();
    test__epoll_wait__noreturn();
    test__epoll_wait__arg1__notbool();
    test__epoll_wait__arg1__notuninit();
    test__epoll_wait__arg2__notbool();
    test__epoll_wait__arg2__notnull();
    test__epoll_wait__arg3__notbool();
    test__epoll_wait__arg3__notuninit();
    test__epoll_wait__arg4__notbool();
    test__epoll_wait__arg4__notuninit();
    test__epoll_pwait__noreturn();
    test__epoll_pwait__arg1__notbool();
    test__epoll_pwait__arg1__notuninit();
    test__epoll_pwait__arg2__notbool();
    test__epoll_pwait__arg2__notnull();
    test__epoll_pwait__arg3__notbool();
    test__epoll_pwait__arg3__notuninit();
    test__epoll_pwait__arg4__notbool();
    test__epoll_pwait__arg4__notuninit();
    test__epoll_pwait__arg5__notbool();
    test__epoll_pwait__arg5__notnull();
    test__epoll_pwait__arg5__notuninit();
    return 0;
}
