...
//
// Usage:
// $ cppcheck --check-library --library=libcurl --enable=style,performance,portability,warning,information --inconclusive --error-exitcode=1 --disable=missingInclude --inline-suppr test/cfg/libcurl.c
// =>
