...
int main() {
    test__toascii__noreturn();
    test__toascii__leakignore();
    test__vfprintf_P__noreturn();
    test__vfprintf_P__leakignore();
    test__vfprintf_P__arg1__notnull();
    test__vfprintf_P__arg1__notuninit();
    test__printf_P__noreturn();
    test__printf_P__leakignore();
    test__sprintf_P__noreturn();
    test__sprintf_P__leakignore();
    test__snprintf_P__noreturn();
    test__snprintf_P__leakignore();
    test__vsprintf_P__noreturn();
    test__vsprintf_P__leakignore();
    test__vsnprintf_P__noreturn();
    test__vsnprintf_P__leakignore();
    test__fprintf_P__noreturn();
    test__fprintf_P__leakignore();
    test__fprintf_P__arg1__notnull();
    test__fprintf_P__arg1__notuninit();
    test__fputs_P__noreturn();
    test__fputs_P__leakignore();
    test__fputs_P__arg1__notnull();
    test__fputs_P__arg1__notuninit();
    test__fputs_P__arg2__notnull();
    test__fputs_P__arg2__notuninit();
    test__puts_P__noreturn();
    test__puts_P__leakignore();
    test__puts_P__arg1__notbool();
    test__puts_P__arg1__notnull();
    test__puts_P__arg1__notuninit();
    test__scanf_P__noreturn();
    test__scanf_P__leakignore();
    test__scanf_P__arg1__notuninit();
    test__fscanf_P__noreturn();
    test__fscanf_P__leakignore();
    test__fscanf_P__arg1__notuninit();
    test__sscanf_P__noreturn();
    test__sscanf_P__leakignore();
    test__fdevopen__noreturn();
    test__fdevopen__arg1__notnull();
    test__fdevopen__arg1__notuninit();
    test__fdevopen__arg2__notnull();
    test__fdevopen__arg2__notuninit();
    test__ltoa__noreturn();
    test__ltoa__leakignore();
    test__ltoa__arg1__notuninit();
    test__ltoa__arg2__notnull();
    test__ltoa__arg2__notuninit();
    test__ltoa__arg3__notnull();
    test__ltoa__arg3__notuninit();
    test__utoa__noreturn();
    test__utoa__leakignore();
    test__utoa__arg1__notuninit();
    test__utoa__arg2__notnull();
    test__utoa__arg2__notuninit();
    test__utoa__arg3__notnull();
    test__utoa__arg3__notuninit();
    test__ultoa__noreturn();
    test__ultoa__leakignore();
    test__ultoa__arg1__notuninit();
    test__ultoa__arg2__notnull();
    test__ultoa__arg2__notuninit();
    test__ultoa__arg3__notnull();
    test__ultoa__arg3__notuninit();
    test__random__noreturn();
    test__random__leakignore();
    test__random_r__noreturn();
    test__random_r__leakignore();
    test__random_r__arg1__notnull();
    test__srandom__noreturn();
    test__srandom__leakignore();
    test__srandom__arg1__notuninit();
    test__dtostre__noreturn();
    test__dtostre__leakignore();
    test__dtostre__arg1__notuninit();
    test__dtostre__arg2__notnull();
    test__dtostrf__noreturn();
    test__dtostrf__leakignore();
    test__dtostrf__arg1__notuninit();
    test__dtostrf__arg2__notuninit();
    test__dtostrf__arg3__notuninit();
    test__dtostrf__arg4__notnull();
    test__ffs__noreturn();
