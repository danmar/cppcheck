...
//
// Usage:
// $ cppcheck --check-library --library=posix --enable=information --error-exitcode=1 --inline-suppr
// --suppress=missingIncludeSystem test/cfg/posix.c
// =>
...
int no_resourceLeak_mkstemp_02(char* template) { return mkstemp(template); }
