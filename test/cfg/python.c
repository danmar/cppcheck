...
//
// Usage:
// $ cppcheck --check-library --library=python --enable=style,performance,portability,warning,information --inconclusive --error-exitcode=1 --disable=missingInclude --inline-suppr test/cfg/python.c
// =>
