...
//
// Usage:
// $ cppcheck --check-library --library=openssl --enable=information --error-exitcode=1 --inline-suppr
// --suppress=missingIncludeSystem test/cfg/openssl.c
// =>
...
void valid_code(BIO* bio) { BIO_printf(bio, "%d\n", 1); }
