...
//
// Usage:
// $ cppcheck --check-library --library=openssl --enable=style,performance,portability,warning,information --inconclusive --error-exitcode=1 --disable=missingInclude --inline-suppr test/cfg/openssl.c
// =>
