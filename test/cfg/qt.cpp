...
//
// Usage:
// $ cppcheck --check-library --library=qt --enable=style,performance,portability,warning,information --inconclusive --error-exitcode=1 --disable=missingInclude --inline-suppr test/cfg/qt.cpp
// =>
