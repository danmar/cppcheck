...
//
// Usage:
// $ cppcheck --check-library --library=googletest --enable=style,performance,portability,warning,information --inconclusive --error-exitcode=1 --disable=missingInclude --inline-suppr test/cfg/googletest.cpp
// =>
