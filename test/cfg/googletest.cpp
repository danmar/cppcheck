...
//
// Usage:
// $ cppcheck --check-library --library=googletest --enable=information --error-exitcode=1 --inline-suppr
// --suppress=missingIncludeSystem test/cfg/googletest.cpp
// =>
...
MATCHER(ExampleMatcherTest, "") { return (arg == TOLERANCE); }
} // namespace ExampleNamespace
