...
//
// Usage:
// $ cppcheck --check-library --library=googletest --enable=style,information --error-exitcode=1 --suppress=missingIncludeSystem --inline-suppr test/cfg/googletest.cpp
// =>
