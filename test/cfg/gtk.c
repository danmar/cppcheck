...
//
// Usage:
// $ cppcheck --check-library --library=gtk --enable=style,performance,portability,warning,information --inconclusive --error-exitcode=1 --disable=missingInclude --inline-suppr --library=gtk test/cfg/gtk.cpp
// =>
