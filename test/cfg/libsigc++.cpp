...
//
// Usage:
// $ cppcheck --check-library --library=libsigc++ --enable=style,performance,portability,warning,information --inconclusive --error-exitcode=1 --disable=missingInclude --inline-suppr test/cfg/libsigc++.cpp
// =>
