...
#define PLATFORM( P, T ) do { std::string errstr; assertEquals(__FILE__, __LINE__, true, P.set(Platform::toString(T), errstr, {Path::getPathFromFilename(exename)}), errstr); } while (false)
