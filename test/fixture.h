...
#define PLATFORM( P, T ) do { std::string errstr; assertEquals(__FILE__, __LINE__, true, P.platform(cppcheck::Platform::platformString(T), errstr, {exename}), errstr); } while (false)
