...
private:
    ...
    {
        REDIRECT;
        const char *argv[] = {"cppcheck", "-v", "fÌle.cpp"};
        Settings settings;
        CmdLineParser parser(&settings);
    ...
    {
        REDIRECT;
        const char *argv[] = {"cppcheck", "--verbose", "fÌle.cpp"};
        Settings settings;
        CmdLineParser parser(&settings);
        ASSERT(parser.ParseFromArgs(3, argv));
        ASSERT_EQUALS(true, settings._verbose);
    ...
    {
        REDIRECT;
        const char *argv[] = {"cppcheck", "--debug", "fÌle.cpp"};
        Settings settings;
        CmdLineParser parser(&settings);
        ASSERT(parser.ParseFromArgs(3, argv));
    ...
    {
        REDIRECT;
        const char *argv[] = {"cppcheck", "--debug-warnings", "fÌle.cpp"};
        Settings settings;
        CmdLineParser parser(&settings);
        ASSERT(parser.ParseFromArgs(3, argv));
    ...
    {
        REDIRECT;
        const char *argv[] = {"cppcheck", "-f", "fÌle.cpp"};
        Settings settings;
        CmdLineParser parser(&settings);
        ASSERT(parser.ParseFromArgs(3, argv));
    ...
    {
        REDIRECT;
        const char *argv[] = {"cppcheck", "--force", "fÌle.cpp"};
        Settings settings;
        CmdLineParser parser(&settings);
        ASSERT(parser.ParseFromArgs(3, argv));
        ASSERT_EQUALS(true, settings._force);
    ...
    {
        REDIRECT;
        const char *argv[] = {"cppcheck", "-q", "fÌle.cpp"};
        Settings settings;
        CmdLineParser parser(&settings);
        ASSERT(parser.ParseFromArgs(3, argv));
    ...
    {
        REDIRECT;
        const char *argv[] = {"cppcheck", "--quiet", "fÌle.cpp"};
        Settings settings;
        CmdLineParser parser(&settings);
        ASSERT(parser.ParseFromArgs(3, argv));
        ASSERT_EQUALS(true, settings._errorsOnly);
