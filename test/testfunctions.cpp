...
private:
    ...
    void checkIgnoredReturnValue()
    {
        ...
        check("bool mystrcmp(char* a, char* b);\n" // cppcheck sees a custom strcmp definition, but it returns a value.
                                                   // Assume it is the one specified in the library.
              "void foo() {\n"
              "    mystrcmp(a, b);\n"
              "}",
              "test.cpp",
    ...
    void checkMissingReturn()
    {
        ...
        ASSERT_EQUALS(
            "[test.cpp:1]: (error, inconclusive) Found a exit path from function with non-void return type that has missing return statement\n",
            errout.str());
    }
    ...
    void returnLocalStdMove1()
    {
        ...
        ASSERT_EQUALS(
            "[test.cpp:1]: (performance) Using std::move for returning object by-value from function will affect copy elision optimization."
