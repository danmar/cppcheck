...
#define CLASS_FUNC_THROW(x, y) const Function *x = findFunctionByName(#x, y); \
    ...
    void valuetype() {
        ...
        TODO_ASSERT_EQUALS("signed int", "unsigned int", typeOf("0xFF;", "0xFF", "test.c", &s));
        ASSERT_EQUALS("unsigned int", typeOf("0xFFU;", "0xFFU", "test.c", &s));
        TODO_ASSERT_EQUALS("unsigned int", "unsigned long", typeOf("0xFFFF;", "0xFFFF", "test.c", &s));
        TODO_ASSERT_EQUALS("signed long", "unsigned long", typeOf("0xFFFFFF;", "0xFFFFFF", "test.c", &s));
        ASSERT_EQUALS("unsigned long", typeOf("0xFFFFFFU;", "0xFFFFFFU", "test.c", &s));
        TODO_ASSERT_EQUALS("unsigned long", "unsigned long long", typeOf("0xFFFFFFFF;", "0xFFFFFFFF", "test.c", &s));
        TODO_ASSERT_EQUALS("signed long long", "unsigned long long", typeOf("0xFFFFFFFFFFFF;", "0xFFFFFFFFFFFF", "test.c", &s));
