...
void CmdLineParser::PrintHelp()
{
    std::cout <<   "Cppcheck - A tool for static C/C++ code analysis\n"
              ...
              "                         several paths. First given path is checked for contained\n"
              "                         header files first. If paths are relative to source files,\n"
              "                         this is not needed.\n"
              "    --includes-file=<file>\n"
              "                         Specify directory paths to search for included header files\n"
              "                         in a text file. Add one include path per line.\n"
              "                         First given path is checked for contained header files first.\n"
