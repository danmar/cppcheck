...
void HelpBrowser::setHelpEngine(QHelpEngine* helpEngine) { mHelpEngine = helpEngine; }
...
static QString getHelpFile()
{
    ...
    QStringList paths;
    paths << (datadir + "/help") << datadir << (QApplication::applicationDirPath() + "/help")
...
HelpDialog::HelpDialog(QWidget* parent) : QDialog(parent), mUi(new Ui::HelpDialog)
{
    mUi->setupUi(this);
...
HelpDialog::~HelpDialog() { delete mUi; }
