...
StatsDialog::StatsDialog(QWidget* parent) : QDialog(parent), mStatistics(nullptr)
{
    mUI.setupUi(this);
...
void StatsDialog::setPathSelected(const QString& path) { mUI.mPath->setText(path); }

void StatsDialog::setNumberOfFilesScanned(int num) { mUI.mNumberOfFilesScanned->setText(QString::number(num)); }
...
{
    const QString Stat = QString("<center><h1>%1   %2</h1></center>\n"
...
void StatsDialog::copyToClipboard()
{
    ...
    // Plain text summary
    const QString settings = QString("%1\n"
                                     "\t%2:\t%3\n"
                                     "\t%4:\t%5\n"
                                     "\t%6:\t%7\n"
                                     "\t%8:\t%9\n"
    ...
    const QString previous = QString("%1\n"
                                     "\t%2:\t%3\n"
                                     "\t%4:\t%5\n"
                                     "\t%6:\t%7\n")
                                 .arg(prevScan)
    ...
    const QString statistics = QString("%1\n"
                                       "\t%2:\t%3\n"
                                       "\t%4:\t%5\n"
                                       "\t%6:\t%7\n"
                                       "\t%8:\t%9\n"
    ...
    // HTML summary
    const QString htmlSettings = QString("<h3>%1<h3>\n"
                                         "<table>\n"
    ...
    const QString htmlPrevious = QString("<h3>%1</h3>\n"
                                         "<table>\n"
                                         " <tr><th>%2:</th><td>%3</td></tr>\n"
                                         " <tr><th>%4:</th><td>%5</td></tr>\n"
                                         " <tr><th>%6:</th><td>%7</td></tr>\n"
    ...
    const QString htmlStatistics = QString("<h3>%1</h3>\n"
                                           " <tr><th>%2:</th><td>%3</td></tr>\n"
                                           " <tr><th>%4:</th><td>%5</td></tr>\n"
                                           " <tr><th>%6:</th><td>%7</td></tr>\n"
                                           " <tr><th>%8:</th><td>%9</td></tr>\n"
